...
export const users = mysqlTable("users", {
  ...
  userType: mysqlEnum("userType", ["individual", "institutional"]).default(
    "individual"
  ),
  ...
  instructorTier: mysqlEnum("instructorTier", [
    "provisional",
    "qualified",
    "lead_instructor",
  ]),
  ...
  safeTruthGuardianAckVersion: varchar("safeTruthGuardianAckVersion", {
    length: 16,
  }),
...
export const enrollments = mysqlTable("enrollments", {
  ...
  enrollmentStatus: mysqlEnum("enrollmentStatus", ["active", "cancelled"])
    .default("active")
    .notNull(),
   ...
   */
  fellowshipGrandfathered: boolean("fellowshipGrandfathered")
    .default(false)
    .notNull(),
  ...
  fellowshipGrandfatheredByName: varchar("fellowshipGrandfatheredByName", {
    length: 255,
  }),
  /**
  ...
  precourseAssessmentPassed: boolean("precourseAssessmentPassed").default(
    false
  ),
  ...
  cognitiveModulesCompletedAt: timestamp("cognitiveModulesCompletedAt"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
 ...
 */
export const ierpProgramEnrollments = mysqlTable(
  "ierpProgramEnrollments",
  {
    ...
    lifecycleStatus: mysqlEnum("lifecycleStatus", [
      ...
      .default("active")
      .notNull(),
    phaseStatus: mysqlEnum("phaseStatus", [
      "phase_1",
      "phase_2",
      "phase_3",
      "completed",
      ...
      .default("phase_1")
      .notNull(),
    phase1Status: mysqlEnum("phase1Status", [
      "not_started",
      "in_progress",
      "submitted",
      "verified",
  ...
  table => ({
    userProgramUnique: uniqueIndex(
      "ierp_program_enrollments_user_program_uq"
    ).on(table.userId, table.programKey),
    userStatusIdx: index("ierp_program_enrollments_user_status_idx").on(
      table.userId,
...
export type InsertIerpProgramEnrollment =
  typeof ierpProgramEnrollments.$inferInsert;

/** Intern profile evidence required before an IERP learner can begin the programme. */
export const ierpInternProfiles = mysqlTable(
  "ierpInternProfiles",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    officialLetterReferenceNumber: varchar("officialLetterReferenceNumber", {
      length: 255,
    }).notNull(),
    effectiveCommencementDate: timestamp("effectiveCommencementDate").notNull(),
    deploymentLetterKey: varchar("deploymentLetterKey", {
      length: 512,
    }).notNull(),
    deploymentLetterFileName: varchar("deploymentLetterFileName", {
      length: 255,
    }).notNull(),
    deploymentLetterContentType: varchar("deploymentLetterContentType", {
      length: 128,
    }).notNull(),
    deploymentLetterSizeBytes: int("deploymentLetterSizeBytes").notNull(),
    status: mysqlEnum("status", ["pending", "verified", "rejected", "revoked"])
      .default("pending")
      .notNull(),
...
export const ierpPhase1Evidence = mysqlTable(
  "ierpPhase1Evidence",
  {
    ...
    status: mysqlEnum("status", ["submitted", "verified", "rejected"])
      .default("submitted")
      .notNull(),
  ...
  table => ({
    enrollmentDocumentUnique: uniqueIndex(
      "ierp_phase1_evidence_enrollment_document_uq"
    ).on(table.programEnrollmentId, table.documentType),
    userStatusIdx: index("ierp_phase1_evidence_user_status_idx").on(
      table.userId,
      table.status
    ),
  })
...
export const ierpPayments = mysqlTable(
  "ierpPayments",
  {
    id: int("id").autoincrement().primaryKey(),
    programEnrollmentId: int("programEnrollmentId").notNull(),
    ...
    phase: mysqlEnum("phase", ["phase_1", "phase_2", "phase_3", "general"])
      .default("general")
      .notNull(),
  ...
  table => ({
    userStatusIdx: index("ierp_payments_user_status_idx").on(
      table.userId,
      table.status
    ),
    programStatusIdx: index("ierp_payments_program_status_idx").on(
...
export const ierpEmailCampaigns = mysqlTable("ierpEmailCampaigns", {
  ...
  scheduleState: mysqlEnum("scheduleState", ["draft", "paused"])
    .default("draft")
    .notNull(),
...
export const ierpEmailPreferences = mysqlTable(
  ...
  table => ({
    userProgramUnique: uniqueIndex("ierp_email_preferences_user_program_uq").on(
      table.userId,
      table.programKey
    ),
  })
...
export type InsertIerpEmailPreference =
  typeof ierpEmailPreferences.$inferInsert;
...
export type InsertIerpEmailSuppression =
  typeof ierpEmailSuppressions.$inferInsert;

export const ierpEmailAttributions = mysqlTable(
  ...
  table => ({
    campaignEventIdx: index("ierp_email_attributions_campaign_event_idx").on(
      table.campaignId,
      table.eventType
    ),
    attributionUnique: uniqueIndex("ierp_email_attributions_key_uq").on(
...
export type InsertIerpEmailAttribution =
  typeof ierpEmailAttributions.$inferInsert;

export const ierpEmailAuditLog = mysqlTable(
  "ierpEmailAuditLog",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    campaignAuditIdx: index("ierp_email_audit_campaign_idx").on(
      table.campaignId,
      table.createdAt
    ),
  })
...
export const certificates = mysqlTable("certificates", {
  ...
  readinessPathway: mysqlEnum("readinessPathway", [
    "ierp",
    "nerp",
    "open_enrolment",
  ]),
...
export type CertificateDownloadFeedback =
  typeof certificateDownloadFeedback.$inferSelect;
export type InsertCertificateDownloadFeedback =
  typeof certificateDownloadFeedback.$inferInsert;
...
export const careSignalEvents = mysqlTable("careSignalEvents", {
  ...
  eligibleForFellowship: boolean("eligibleForFellowship")
    .default(true)
    .notNull(),
  /** Form version used for submission — audit trail (migration 0037) */
  submissionVersion: varchar("submissionVersion", { length: 16 })
    .default("v1")
    .notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  reportTrack: varchar("report_track", { length: 16 })
    .default("FAILURE")
    .notNull(),
   ...
   *     migration exists).
   */
  submissionMode: mysqlEnum("submissionMode", [
    "named",
    "pseudonymous",
    "anonymous",
  ])
...
export const codeSignalEvents = mysqlTable("codeSignalEvents", {
  ...
  schemaVersion: varchar("schema_version", { length: 16 })
    .default("1.0")
    .notNull(),
  reportTrack: mysqlEnum("report_track", ["FAILURE", "SUCCESS"])
    .default("FAILURE")
    .notNull(),
  ...
  submissionMode: mysqlEnum("submissionMode", ["named", "anonymous"])
    .default("named")
    .notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  /**
...
export type InsertInstitutionalAccount =
  typeof institutionalAccounts.$inferInsert;
 ...
 */
export const institutionalAccountAdmins = mysqlTable(
...
export type InstitutionalAccountAdmin =
  typeof institutionalAccountAdmins.$inferSelect;
export type InsertInstitutionalAccountAdmin =
  typeof institutionalAccountAdmins.$inferInsert;
 ...
 */
export const institutionalAdminInvites = mysqlTable(
  "institutionalAdminInvites",
  {
    ...
    status: mysqlEnum("status", ["pending", "accepted", "revoked"]).default(
      "pending"
    ),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
...
export type InstitutionalAdminInvite =
  typeof institutionalAdminInvites.$inferSelect;
export type InsertInstitutionalAdminInvite =
  typeof institutionalAdminInvites.$inferInsert;
 ...
 */
export const institutionalRecoveryRequests = mysqlTable(
  "institutionalRecoveryRequests",
  {
    id: int("id").autoincrement().primaryKey(),
    companyNameClaimed: varchar("companyNameClaimed", {
      length: 255,
    }).notNull(),
    claimedRegistrationNumber: varchar("claimedRegistrationNumber", {
      length: 255,
    }),
...
export type InstitutionalRecoveryRequest =
  typeof institutionalRecoveryRequests.$inferSelect;
export type InsertInstitutionalRecoveryRequest =
  typeof institutionalRecoveryRequests.$inferInsert;
...
export type InsertInstitutionalInquiry =
  typeof institutionalInquiries.$inferInsert;

/** One institution-paid cohort order for Paeds Resus competency-based training. */
export const institutionalTrainingOrders = mysqlTable(
  "institutionalTrainingOrders",
  {
    ...
    paymentStatus: mysqlEnum("paymentStatus", [
      ...
      .default("pending")
      .notNull(),
    /** ILS operational lifecycle; paymentStatus remains the financial state. */
    ...
    deliverySessionId: int("deliverySessionId"),
    capacityConfirmed: boolean("capacityConfirmed").default(false).notNull(),
    instructorConfirmed: boolean("instructorConfirmed")
      .default(false)
      .notNull(),
    venueConfirmed: boolean("venueConfirmed").default(false).notNull(),
    equipmentConfirmed: boolean("equipmentConfirmed").default(false).notNull(),
    practicalDateConfirmed: boolean("practicalDateConfirmed")
      .default(false)
      .notNull(),
    claimsAcknowledged: boolean("claimsAcknowledged").default(false).notNull(),
    rosterConfirmed: boolean("rosterConfirmed").default(false).notNull(),
    readinessConfirmedAt: timestamp("readinessConfirmedAt"),
    readinessConfirmedByUserId: int("readinessConfirmedByUserId"),
...
export type InstitutionalTrainingOrder =
  typeof institutionalTrainingOrders.$inferSelect;
export type InsertInstitutionalTrainingOrder =
  typeof institutionalTrainingOrders.$inferInsert;

/** Provider membership in an institution-paid Institutional Life Support order. */
export const institutionalTrainingOrderProviders = mysqlTable(
  "institutionalTrainingOrderProviders",
  {
    ...
    assignmentStatus: mysqlEnum("assignmentStatus", [
      ...
      .default("active")
      .notNull(),
    replacedAt: timestamp("replacedAt"),
    replacedByUserId: int("replacedByUserId"),
    replacementReason: varchar("replacementReason", { length: 255 }),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  }
);

export type InstitutionalTrainingOrderProvider =
  typeof institutionalTrainingOrderProviders.$inferSelect;
export type InsertInstitutionalTrainingOrderProvider =
  typeof institutionalTrainingOrderProviders.$inferInsert;
...
export type InsertIlsCredentialRequest =
  typeof ilsCredentialRequests.$inferInsert;

/**
 * ILS delivery capacity and practical-assessment session. This is separate
 * from generic trainingSchedules so institution-paid ILS orders cannot be
 * mistaken for IERS readiness or another training product.
 */
export const ilsDeliverySessions = mysqlTable(
  "ilsDeliverySessions",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionalAccountId: int("institutionalAccountId").notNull(),
    orderId: int("orderId"),
    sessionStatus: mysqlEnum("sessionStatus", [
      "proposed",
      "confirmed",
      "in_progress",
      "completed",
  ...
  table => ({
    institutionStatusIndex: index(
      "ils_delivery_sessions_institution_status_idx"
    ).on(table.institutionalAccountId, table.sessionStatus),
    scheduledDateIndex: index("ils_delivery_sessions_scheduled_date_idx").on(
      table.scheduledDate
    ),
  })
);
export type IlsDeliverySession = typeof ilsDeliverySessions.$inferSelect;
export type InsertIlsDeliverySession = typeof ilsDeliverySessions.$inferInsert;

/** Versioned practical evidence captured by an approved assessor. */
export const ilsPracticalAssessments = mysqlTable(
  "ilsPracticalAssessments",
  {
    id: int("id").autoincrement().primaryKey(),
    enrollmentId: int("enrollmentId").notNull(),
    deliverySessionId: int("deliverySessionId").notNull(),
    assessorUserId: int("assessorUserId").notNull(),
    checklistVersion: varchar("checklistVersion", { length: 64 })
      .default("ils-v1")
      .notNull(),
    assessorCalibrationConfirmed: boolean("assessorCalibrationConfirmed")
      .default(false)
      .notNull(),
    secondAssessorUserId: int("secondAssessorUserId"),
    ...
    remediationDueAt: timestamp("remediationDueAt"),
    remediationCompletedAt: timestamp("remediationCompletedAt"),
    notes: text("notes"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    enrollmentIndex: index("ils_practical_assessments_enrollment_idx").on(
      table.enrollmentId
    ),
    sessionResultIndex: index(
      "ils_practical_assessments_session_result_idx"
    ).on(table.deliverySessionId, table.result),
  })
);
export type IlsPracticalAssessment =
  typeof ilsPracticalAssessments.$inferSelect;
export type InsertIlsPracticalAssessment =
  typeof ilsPracticalAssessments.$inferInsert;

/** Deduped reminders and follow-ups for the ILS lifecycle. */
export const ilsReminderEvents = mysqlTable(
  "ilsReminderEvents",
  {
    id: int("id").autoincrement().primaryKey(),
    enrollmentId: int("enrollmentId"),
    ...
    channel: mysqlEnum("channel", ["email", "sms", "in_app"])
      .default("email")
      .notNull(),
  ...
  table => ({
    reminderDedupIndex: uniqueIndex("ils_reminder_events_dedup_idx").on(
      table.enrollmentId,
      table.orderId,
      table.userId,
      table.reminderType,
    ...
    dueStatusIndex: index("ils_reminder_events_due_status_idx").on(
      table.dueAt,
      table.status
    ),
  })
);
export type IlsReminderEvent = typeof ilsReminderEvents.$inferSelect;
export type InsertIlsReminderEvent = typeof ilsReminderEvents.$inferInsert;

/** Auditable operational exceptions and support cases for ILS. */
export const ilsOperationalCases = mysqlTable(
  "ilsOperationalCases",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    statusPriorityIndex: index("ils_operational_cases_status_priority_idx").on(
      table.status,
      table.priority
    ),
    institutionIndex: index("ils_operational_cases_institution_idx").on(
      table.institutionalAccountId
    ),
  })
);
export type IlsOperationalCase = typeof ilsOperationalCases.$inferSelect;
export type InsertIlsOperationalCase = typeof ilsOperationalCases.$inferInsert;

/** Pilot cohort governance and go/no-go state. */
export const ilsPilotCohorts = mysqlTable(
  "ilsPilotCohorts",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionalAccountId: int("institutionalAccountId").notNull(),
    ...
    name: varchar("name", { length: 255 }).notNull(),
    targetProviderCount: int("targetProviderCount").notNull(),
    minimumProviderCount: int("minimumProviderCount").default(1).notNull(),
    status: mysqlEnum("status", [
      "planned",
      "active",
      "completed",
    ...
    clinicalOwnerUserId: int("clinicalOwnerUserId"),
    operationalOwnerUserId: int("operationalOwnerUserId"),
    coordinatorUserId: int("coordinatorUserId"),
    venueConfirmed: boolean("venueConfirmed").default(false).notNull(),
    equipmentConfirmed: boolean("equipmentConfirmed").default(false).notNull(),
    practicalDateConfirmed: boolean("practicalDateConfirmed")
      ...
      .notNull(),
    claimsAcknowledged: boolean("claimsAcknowledged").default(false).notNull(),
    successReviewAt: timestamp("successReviewAt"),
    notes: text("notes"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    institutionStatusIndex: index(
      "ils_pilot_cohorts_institution_status_idx"
    ).on(table.institutionalAccountId, table.status),
  })
);
export type IlsPilotCohort = typeof ilsPilotCohorts.$inferSelect;
export type InsertIlsPilotCohort = typeof ilsPilotCohorts.$inferInsert;

/** Operational pilot scorecard; this stores delivery evidence, not clinical claims. */
export const ilsPilotMetrics = mysqlTable(
  "ilsPilotMetrics",
  {
    id: int("id").autoincrement().primaryKey(),
    pilotCohortId: int("pilotCohortId").notNull(),
    orderId: int("orderId"),
    measuredAt: timestamp("measuredAt").defaultNow().notNull(),
    paymentToAccessSuccessPercent: decimal("paymentToAccessSuccessPercent", {
      precision: 5,
      scale: 2,
    }).notNull(),
    activationWithin7dPercent: decimal("activationWithin7dPercent", {
      precision: 5,
      scale: 2,
    }).notNull(),
    cognitiveWithin30dPercent: decimal("cognitiveWithin30dPercent", {
      precision: 5,
      scale: 2,
    }).notNull(),
    practicalOpportunityWithin14dPercent: decimal(
      "practicalOpportunityWithin14dPercent",
      { precision: 5, scale: 2 }
    ).notNull(),
    practicalPassPercent: decimal("practicalPassPercent", {
      precision: 5,
      scale: 2,
    }).notNull(),
    supportMinutesPerProvider: int("supportMinutesPerProvider"),
    costPerProviderKes: int("costPerProviderKes"),
    marginPerProviderKes: int("marginPerProviderKes"),
    coordinatorSatisfactionScore: int("coordinatorSatisfactionScore"),
    notes: text("notes"),
  ...
  table => ({
    pilotDateIndex: index("ils_pilot_metrics_pilot_date_idx").on(
      table.pilotCohortId,
      table.measuredAt
    ),
  })
);
export type IlsPilotMetric = typeof ilsPilotMetrics.$inferSelect;
export type InsertIlsPilotMetric = typeof ilsPilotMetrics.$inferInsert;
...
export const experiments = mysqlTable("experiments", {
  ...
  statisticalSignificance: decimal("statisticalSignificance", {
    precision: 5,
    scale: 2,
  }), // p-value
  createdAt: timestamp("createdAt").defaultNow().notNull(),
...
export const featureFlags = mysqlTable("featureFlags", {
  ...
  targetUserType: mysqlEnum("targetUserType", [
    "all",
    "admin",
    "individual",
    "institutional",
...
export type InsertConversionFunnelEvent =
  typeof conversionFunnelEvents.$inferInsert;
...
export const chainOfSurvivalCheckpoints = mysqlTable(
  "chainOfSurvivalCheckpoints",
  {
    ...
    cprQuality: mysqlEnum("cprQuality", [
      "excellent",
      "good",
      "adequate",
      "poor",
    ...
    postResuscitationCompleted: boolean("postResuscitationCompleted").default(
      false
    ),
...
export type ChainOfSurvivalCheckpoint =
  typeof chainOfSurvivalCheckpoints.$inferSelect;
export type InsertChainOfSurvivalCheckpoint =
  typeof chainOfSurvivalCheckpoints.$inferInsert;
...
export const facilityScores = mysqlTable("facilityScores", {
  ...
  staffEngagementScore: decimal("staffEngagementScore", {
    precision: 5,
    scale: 2,
  }).default("0"), // 0-100
  eventReportingFrequency: int("eventReportingFrequency").default(0), // events per month
  insightAdoptionRate: decimal("insightAdoptionRate", {
    precision: 5,
    scale: 2,
  }).default("0"), // percentage
  overallScore: decimal("overallScore", { precision: 5, scale: 2 }).default(
    "0"
  ), // 0-100 composite score
  scoreVisibility: mysqlEnum("scoreVisibility", [
    "hidden",
    "visible_to_facility",
    "public",
  ]).default("hidden"),
...
export const accreditationApplications = mysqlTable(
...
export type AccreditationApplication =
  typeof accreditationApplications.$inferSelect;
export type InsertAccreditationApplication =
  typeof accreditationApplications.$inferInsert;
...
export const microCourses = mysqlTable("microCourses", {
  ...
  emergencyType: mysqlEnum("emergencyType", [
    "respiratory",
    "shock",
    "seizure",
    "toxicology",
...
export type InsertMicroCourseEnrollment =
  typeof microCourseEnrollments.$inferInsert;
...
export const institutionalStaffMembers = mysqlTable(
  "institutionalStaffMembers",
  {
    ...
    facilityLinkStatus: mysqlEnum("facilityLinkStatus", [
      "pending",
      "linked",
      "rejected",
    ]).default("pending"),
    ...
    totalPaidAmount: decimal("totalPaidAmount", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    ...
    certificationStatus: mysqlEnum("certificationStatus", [
      "not_started",
      "in_progress",
      "certified",
      "expired",
...
export type InstitutionalStaffMember =
  typeof institutionalStaffMembers.$inferSelect;
export type InsertInstitutionalStaffMember =
  typeof institutionalStaffMembers.$inferInsert;
...
export const institutionalProducts = mysqlTable("institutionalProducts", {
  ...
  description: text("description").notNull(),
  productKind: mysqlEnum("productKind", ["core", "transitional"])
    .default("core")
    .notNull(),
  lifecycleStatus: mysqlEnum("lifecycleStatus", [
    "active",
  ...
  privacyClass: varchar("privacyClass", { length: 64 })
...
export const institutionalProductCapabilities = mysqlTable(
  "institutionalProductCapabilities",
  {
    ...
    renewalPolicy: mysqlEnum("renewalPolicy", [
      ...
      .notNull(),
    description: text("description").notNull(),
    status: mysqlEnum("status", ["active", "retired"])
      .default("active")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  ...
  table => ({
    productCapabilityUnique: uniqueIndex(
      "institutionalProductCapabilities_product_capability_unique"
    ).on(table.productId, table.capabilityKey),
    productStatusIndex: index(
      "institutionalProductCapabilities_product_status_idx"
    ).on(table.productId, table.status),
  })
);
export type InstitutionalProductCapability =
  typeof institutionalProductCapabilities.$inferSelect;
export type InsertInstitutionalProductCapability =
  typeof institutionalProductCapabilities.$inferInsert;

/** Commercial plan metadata; prices are snapshots at contract/subscription time. */
export const institutionalProductPlans = mysqlTable(
  "institutionalProductPlans",
  {
    ...
    billingInterval: mysqlEnum("billingInterval", [
      ...
      .default("custom")
      .notNull(),
    billingModel: mysqlEnum("billingModel", [
      "institution",
      "per_staff",
      "per_seat",
      "custom",
  ...
  table => ({
    productPlanUnique: uniqueIndex(
      "institutionalProductPlans_product_plan_unique"
    ).on(table.productId, table.planKey),
    productStatusIndex: index(
      "institutionalProductPlans_product_status_idx"
    ).on(table.productId, table.status),
  })
);
export type InstitutionalProductPlan =
  typeof institutionalProductPlans.$inferSelect;
export type InsertInstitutionalProductPlan =
  typeof institutionalProductPlans.$inferInsert;

/** One current commercial relationship per institution/product; history lives in institutionSubscriptionEvents. */
export const institutionProductSubscriptions = mysqlTable(
  ...
  table => ({
    institutionProductUnique: uniqueIndex(
      "institutionProductSubscriptions_institution_product_unique"
    ).on(table.institutionalAccountId, table.productId),
    institutionStatusIndex: index(
      "institutionProductSubscriptions_institution_status_idx"
    ).on(table.institutionalAccountId, table.subscriptionStatus),
    renewalIndex: index("institutionProductSubscriptions_renewal_idx").on(
      table.subscriptionStatus,
      table.renewsAt
    ),
  })
);
export type InstitutionProductSubscription =
  typeof institutionProductSubscriptions.$inferSelect;
export type InsertInstitutionProductSubscription =
  typeof institutionProductSubscriptions.$inferInsert;

/** Effective capability grants derived from a product subscription. */
export const institutionProductEntitlements = mysqlTable(
  "institutionProductEntitlements",
  {
    ...
    capabilityKey: varchar("capabilityKey", { length: 128 }).notNull(),
    entitlementStatus: mysqlEnum("entitlementStatus", [
      "active",
      "grace",
      "read_only",
      "blocked",
  ...
  table => ({
    institutionCapabilityUnique: uniqueIndex(
      "institutionProductEntitlements_institution_capability_unique"
    ).on(table.institutionalAccountId, table.productId, table.capabilityKey),
    institutionStatusIndex: index(
      "institutionProductEntitlements_institution_status_idx"
    ).on(table.institutionalAccountId, table.entitlementStatus),
  })
);
export type InstitutionProductEntitlement =
  typeof institutionProductEntitlements.$inferSelect;
export type InsertInstitutionProductEntitlement =
  typeof institutionProductEntitlements.$inferInsert;

/** Product-specific roles, separate from shared account administration and IERS responsibility roles. */
export const institutionProductRoles = mysqlTable(
  "institutionProductRoles",
  {
    ...
    roleStatus: mysqlEnum("roleStatus", [
      "invited",
      "active",
      "suspended",
      "ended",
  ...
  table => ({
    institutionEmailRoleUnique: uniqueIndex(
      "institutionProductRoles_institution_product_email_role_unique"
    ).on(
      table.institutionalAccountId,
      table.productId,
      table.invitedEmail,
    ...
    institutionUserIndex: index(
      "institutionProductRoles_institution_user_idx"
    ).on(table.institutionalAccountId, table.userId),
    productStatusIndex: index("institutionProductRoles_product_status_idx").on(
      table.productId,
      table.roleStatus
    ),
  })
);
export type InstitutionProductRole =
  typeof institutionProductRoles.$inferSelect;
export type InsertInstitutionProductRole =
  typeof institutionProductRoles.$inferInsert;

/** Shared institution scopes are intentionally separate from IERS and CPD product roles. */
export const institutionAccountScopes = mysqlTable(
  "institutionAccountScopes",
  {
    ...
    scopeStatus: mysqlEnum("scopeStatus", [
      "invited",
      "active",
      "suspended",
      "ended",
  ...
  table => ({
    institutionEmailScopeUnique: uniqueIndex(
      "institutionAccountScopes_inst_email_scope_uq"
    ).on(table.institutionalAccountId, table.invitedEmail, table.scopeKey),
    institutionUserIndex: index("institutionAccountScopes_inst_user_idx").on(
      table.institutionalAccountId,
      table.userId
    ),
    institutionStatusIndex: index(
      "institutionAccountScopes_inst_status_idx"
    ).on(table.institutionalAccountId, table.scopeStatus),
  })
);
export type InstitutionAccountScope =
  typeof institutionAccountScopes.$inferSelect;
export type InsertInstitutionAccountScope =
  typeof institutionAccountScopes.$inferInsert;

/** Append-only history for shared institution-scope assignments. */
export const institutionAccountScopeEvents = mysqlTable(
  ...
  table => ({
    institutionScopeIndex: index(
      "institutionAccountScopeEvents_inst_scope_idx"
    ).on(table.institutionalAccountId, table.scopeId),
    occurredIndex: index("institutionAccountScopeEvents_occurred_idx").on(
      table.occurredAt
    ),
  })
);
export type InstitutionAccountScopeEvent =
  typeof institutionAccountScopeEvents.$inferSelect;
export type InsertInstitutionAccountScopeEvent =
  typeof institutionAccountScopeEvents.$inferInsert;

/** Append-only commercial and entitlement state history. */
export const institutionSubscriptionEvents = mysqlTable(
...
export type InstitutionSubscriptionEvent =
  typeof institutionSubscriptionEvents.$inferSelect;
export type InsertInstitutionSubscriptionEvent =
  typeof institutionSubscriptionEvents.$inferInsert;

/** Product access decisions and manual overrides for auditability. */
export const institutionEntitlementAuditLog = mysqlTable(
  ...
  table => ({
    institutionDecisionIndex: index(
      "institutionEntitlementAuditLog_institution_decision_idx"
    ).on(table.institutionalAccountId, table.decision),
    productCreatedIndex: index(
      "institutionEntitlementAuditLog_product_created_idx"
    ).on(table.productId, table.createdAt),
  })
);
export type InstitutionEntitlementAuditLog =
  typeof institutionEntitlementAuditLog.$inferSelect;
export type InsertInstitutionEntitlementAuditLog =
  typeof institutionEntitlementAuditLog.$inferInsert;

/** Product-scoped retention and legal-hold policy. */
export const institutionDataLifecyclePolicies = mysqlTable(
  ...
  table => ({
    institutionProductUnique: uniqueIndex(
      "institutionDataLifecyclePolicies_institution_product_unique"
    ).on(table.institutionalAccountId, table.productKey),
  })
);
export type InstitutionDataLifecyclePolicy =
  typeof institutionDataLifecyclePolicies.$inferSelect;
export type InsertInstitutionDataLifecyclePolicy =
  typeof institutionDataLifecyclePolicies.$inferInsert;

/** Append-only control-plane requests for export, retention, recovery, and offboarding. */
export const institutionDataLifecycleRequests = mysqlTable(
  ...
  table => ({
    institutionStatusIndex: index(
      "institutionDataLifecycleRequests_institution_status_idx"
    ).on(table.institutionalAccountId, table.status),
    institutionProductIndex: index(
      "institutionDataLifecycleRequests_institution_product_idx"
    ).on(table.institutionalAccountId, table.productKey),
  })
);
export type InstitutionDataLifecycleRequest =
  typeof institutionDataLifecycleRequests.$inferSelect;
export type InsertInstitutionDataLifecycleRequest =
  typeof institutionDataLifecycleRequests.$inferInsert;

/** Payment receipts linked to an institutional product subscription. */
export const institutionSubscriptionPayments = mysqlTable(
  ...
  table => ({
    paymentIdempotencyUnique: uniqueIndex("inst_sub_pay_idem_uq").on(
      table.idempotencyKey
    ),
    paymentReferenceUnique: uniqueIndex("inst_sub_pay_ref_uq").on(
      table.paymentReference
    ),
    institutionProductIndex: index("inst_sub_pay_prod_idx").on(
      table.institutionalAccountId,
      table.productId
    ),
  })
...
export type InstitutionSubscriptionPayment =
  typeof institutionSubscriptionPayments.$inferSelect;
export type InsertInstitutionSubscriptionPayment =
  typeof institutionSubscriptionPayments.$inferInsert;

/** Pending institutional M-Pesa checkout intents linked to one product subscription. */
export const institutionSubscriptionPaymentIntents = mysqlTable(
  ...
  table => ({
    checkoutRequestUnique: uniqueIndex("inst_sub_intent_checkout_uq").on(
      table.checkoutRequestId
    ),
    idempotencyUnique: uniqueIndex("inst_sub_intent_idem_uq").on(
      table.idempotencyKey
    ),
    receiptUnique: uniqueIndex("inst_sub_intent_receipt_uq").on(
      table.mpesaReceiptNumber
    ),
    institutionStatusIndex: index("inst_sub_intent_status_idx").on(
      table.institutionalAccountId,
      table.status
    ),
  })
);
export type InstitutionSubscriptionPaymentIntent =
  typeof institutionSubscriptionPaymentIntents.$inferSelect;
export type InsertInstitutionSubscriptionPaymentIntent =
  typeof institutionSubscriptionPaymentIntents.$inferInsert;

/** Institution-owned renewal reminder preferences; external channels remain opt-in. */
export const institutionRenewalNotificationPreferences = mysqlTable(
  "institutionRenewalNotificationPreferences",
  {
    ...
    reminderDays: varchar("reminderDays", { length: 64 })
      .default("30,14,7,0")
      .notNull(),
    updatedByUserId: int("updatedByUserId"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => ({
    institutionProductUnique: uniqueIndex("inst_renew_pref_inst_prod_uq").on(
      table.institutionalAccountId,
      table.productKey
    ),
  })
);
export type InstitutionRenewalNotificationPreference =
  typeof institutionRenewalNotificationPreferences.$inferSelect;
export type InsertInstitutionRenewalNotificationPreference =
  typeof institutionRenewalNotificationPreferences.$inferInsert;

/** Deduplicated renewal notices and delivery history. */
export const institutionRenewalNotifications = mysqlTable(
  "institutionRenewalNotifications",
  {
    ...
    channel: mysqlEnum("channel", ["in_app", "email", "sms"])
      .default("in_app")
      .notNull(),
    status: mysqlEnum("status", ["queued", "sent", "failed", "cancelled"])
      .default("queued")
      .notNull(),
  ...
  table => ({
    ...
    institutionStatusIndex: index("inst_renew_notif_status_idx").on(
      table.institutionalAccountId,
      table.status
    ),
    scheduledIndex: index("inst_renew_notif_sched_idx").on(
      table.status,
      table.scheduledFor
    ),
  })
);
export type InstitutionRenewalNotification =
  typeof institutionRenewalNotifications.$inferSelect;
export type InsertInstitutionRenewalNotification =
  typeof institutionRenewalNotifications.$inferInsert;

/** Persisted registry for adjacent, transitional, and connected institutional services. */
export const institutionConnectedServices = mysqlTable(
  ...
  table => ({
    serviceKeyUnique: uniqueIndex("inst_conn_services_key_uq").on(
      table.serviceKey
    ),
    lifecycleIndex: index("inst_conn_services_lifecycle_idx").on(
      table.lifecycleStatus,
      table.enabled
    ),
  })
);
export type InstitutionConnectedService =
  typeof institutionConnectedServices.$inferSelect;
export type InsertInstitutionConnectedService =
  typeof institutionConnectedServices.$inferInsert;

/** Safe Truth governance boundary and processing contract. */
export const safeTruthGovernancePolicies = mysqlTable(
  "safeTruthGovernancePolicies",
  {
    id: int("id").autoincrement().primaryKey(),
    policyKey: varchar("policyKey", { length: 64 }).notNull(),
    boundaryStatus: mysqlEnum("boundaryStatus", [
      "accountless_public",
      "provider_workflow",
      "institutional_aggregate",
      "mixed_review_required",
    ...
    institutionalAnalyticsAllowed: boolean("institutionalAnalyticsAllowed")
      .default(false)
      .notNull(),
    patientIdentifiersAllowed: boolean("patientIdentifiersAllowed")
      .default(false)
      .notNull(),
    providerLinkageAllowed: boolean("providerLinkageAllowed")
      .default(false)
      .notNull(),
  ...
  table => ({
    policyKeyUnique: uniqueIndex("safe_truth_governance_policy_key_uq").on(
      table.policyKey
    ),
  })
);
export type SafeTruthGovernancePolicy =
  typeof safeTruthGovernancePolicies.$inferSelect;
export type InsertSafeTruthGovernancePolicy =
  typeof safeTruthGovernancePolicies.$inferInsert;

/** Append-only review history for the Connected Services registry. */
export const institutionConnectedServiceEvents = mysqlTable(
...
export type InstitutionConnectedServiceEvent =
  typeof institutionConnectedServiceEvents.$inferSelect;
export type InsertInstitutionConnectedServiceEvent =
  typeof institutionConnectedServiceEvents.$inferInsert;

/** Append-only approval history for Safe Truth boundary changes. */
export const safeTruthGovernancePolicyEvents = mysqlTable(
...
export type SafeTruthGovernancePolicyEvent =
  typeof safeTruthGovernancePolicyEvents.$inferSelect;
export type InsertSafeTruthGovernancePolicyEvent =
  typeof safeTruthGovernancePolicyEvents.$inferInsert;
 ...
 */
export const facilityMembershipRequests = mysqlTable(
  ...
  table => ({
    pendingRequestKeyUnique: uniqueIndex(
      "facilityMembershipRequests_pending_request_key_unique"
    ).on(table.pendingRequestKey),
    institutionStatusIndex: index(
      "facilityMembershipRequests_institution_status_idx"
    ).on(table.institutionalAccountId, table.status, table.createdAt),
    userStatusIndex: index("facilityMembershipRequests_user_status_idx").on(
      table.userId,
      table.status,
      table.createdAt
    ),
    facilityIndex: index("facilityMembershipRequests_facility_idx").on(
      table.careFacilityId,
      table.status
    ),
  })
);
export type FacilityMembershipRequest =
  typeof facilityMembershipRequests.$inferSelect;
export type InsertFacilityMembershipRequest =
  typeof facilityMembershipRequests.$inferInsert;
...
export const institutionMemberships = mysqlTable(
  ...
  table => ({
    institutionEmailUnique: uniqueIndex(
      "institutionMemberships_institution_email_unique"
    ).on(table.institutionalAccountId, table.invitedEmail),
    institutionUserIndex: index(
      "institutionMemberships_institution_user_idx"
    ).on(table.institutionalAccountId, table.userId),
    institutionStatusIndex: index(
      "institutionMemberships_institution_status_idx"
    ).on(table.institutionalAccountId, table.membershipStatus),
  })
);
export type InstitutionMembership = typeof institutionMemberships.$inferSelect;
export type InsertInstitutionMembership =
  typeof institutionMemberships.$inferInsert;

/** Append-only audit history for institution membership and roster removal decisions. */
export const institutionMembershipEvents = mysqlTable(
  "institution_membership_events",
  {
    ...
    previousMembershipStatus: varchar("previous_membership_status", {
      length: 32,
    }),
    currentMembershipStatus: varchar("current_membership_status", {
      length: 32,
    }).notNull(),
  ...
  table => ({
    institutionMembershipIndex: index(
      "institution_membership_events_inst_membership_idx"
    ).on(table.institutionalAccountId, table.membershipId),
    occurredIndex: index("institution_membership_events_occurred_idx").on(
      table.occurredAt
    ),
  })
);
export type InstitutionMembershipEvent =
  typeof institutionMembershipEvents.$inferSelect;
export type InsertInstitutionMembershipEvent =
  typeof institutionMembershipEvents.$inferInsert;

/** Durable IERS emergency activation record. */
export const iersActivationEvents = mysqlTable(
  "iersActivationEvents",
  {
    ...
    activationType: mysqlEnum("activationType", [
      "code_blue",
      "code_yellow",
      "neonatal",
      "sepsis",
    ...
    priority: mysqlEnum("priority", ["critical", "high", "routine"])
      .default("critical")
      .notNull(),
  ...
  table => ({
    institutionStatusIndex: index(
      "iersActivationEvents_institution_status_idx"
    ).on(table.institutionalAccountId, table.status),
    institutionTriggeredIndex: index(
      "iersActivationEvents_institution_triggered_idx"
    ).on(table.institutionalAccountId, table.triggeredAt),
  })
);
export type IersActivationEvent = typeof iersActivationEvents.$inferSelect;
export type InsertIersActivationEvent =
  typeof iersActivationEvents.$inferInsert;

/** Per-provider notification, acknowledgement, escalation, and response evidence. */
export const iersActivationResponders = mysqlTable(
  "iersActivationResponders",
  {
    ...
    responsibilityRole: mysqlEnum("responsibilityRole", [
      ...
      .default("ert_responder")
      .notNull(),
    notificationStatus: mysqlEnum("notificationStatus", [
      "pending",
      "sent",
      "delivered",
      "failed",
    ...
    caseJoinMethod: mysqlEnum("caseJoinMethod", [
      "activation_assignment",
      "qr_scan",
    ]).default("activation_assignment"),
  ...
  table => ({
    activationUserUnique: uniqueIndex(
      "iersActivationResponders_activation_user_unique"
    ).on(table.activationEventId, table.userId),
    institutionUserIndex: index(
      "iersActivationResponders_institution_user_idx"
    ).on(table.institutionalAccountId, table.userId),
  })
);
export type IersActivationResponder =
  typeof iersActivationResponders.$inferSelect;
export type InsertIersActivationResponder =
  typeof iersActivationResponders.$inferInsert;

/** One browser/device subscription per endpoint; endpointHash avoids indexing a long URL. */
export const iersPushSubscriptions = mysqlTable(
  ...
  table => ({
    endpointHashUnique: uniqueIndex(
      "iers_push_subscriptions_endpoint_hash_unique"
    ).on(table.endpointHash),
    userActiveIndex: index("iers_push_subscriptions_user_active_idx").on(
      table.userId,
      table.isActive
    ),
  })
...
export type InsertIersPushSubscription =
  typeof iersPushSubscriptions.$inferInsert;

/** Durable outbound push attempt evidence; sent means accepted by the push service, not device receipt. */
export const iersPushDeliveryLog = mysqlTable(
  "iers_push_delivery_log",
  {
    ...
    status: mysqlEnum("status", ["pending", "sent", "failed", "expired"])
      .default("pending")
      .notNull(),
  ...
  table => ({
    deliveryKeyUnique: uniqueIndex("iers_push_delivery_log_key_unique").on(
      table.deliveryKey
    ),
    activationIndex: index("iers_push_delivery_log_activation_idx").on(
      table.activationEventId,
      table.status
    ),
    subscriptionIndex: index("iers_push_delivery_log_subscription_idx").on(
...
export const iersActivationResources = mysqlTable(
  "iers_activation_resources",
  {
    id: int("id").autoincrement().primaryKey(),
    activationEventId: int("activation_event_id").notNull(),
    ...
    sourceType: mysqlEnum("source_type", ["readiness_gap", "manual"])
      .default("manual")
      .notNull(),
  ...
  table => ({
    activationStatusIndex: index(
      "iers_activation_resources_activation_status_idx"
    ).on(table.activationEventId, table.status),
    institutionIndex: index("iers_activation_resources_institution_idx").on(
      table.institutionId,
      table.createdAt
    ),
  })
);
export type IersActivationResource =
  typeof iersActivationResources.$inferSelect;
export type InsertIersActivationResource =
  typeof iersActivationResources.$inferInsert;

/** Append-only individual arrival evidence; self, witnessed, and QR-scanned arrivals remain distinguishable. */
export const iersActivationArrivals = mysqlTable(
  "iers_activation_arrivals",
  {
    id: int("id").autoincrement().primaryKey(),
    activationEventId: int("activation_event_id").notNull(),
    institutionId: int("institution_id").notNull(),
    ...
    arrivalType: mysqlEnum("arrival_type", [
      "self",
      "witnessed",
      "qr_scan",
    ]).notNull(),
  ...
  table => ({
    activationArrivalIndex: index(
      "iers_activation_arrivals_activation_time_idx"
    ).on(table.activationEventId, table.occurredAt),
    providerArrivalIndex: index("iers_activation_arrivals_provider_idx").on(
...
export type InsertIersActivationArrival =
  typeof iersActivationArrivals.$inferInsert;

/** Append-only state transition log for activation evidence and auditability. */
export const iersActivationTimeline = mysqlTable(
  ...
  table => ({
    activationTimeIndex: index("iersActivationTimeline_activation_time_idx").on(
      table.activationEventId,
      table.occurredAt
    ),
  })
...
export type InsertIersActivationTimeline =
  typeof iersActivationTimeline.$inferInsert;
...
export type InsertFellowshipSimulation =
  typeof fellowshipSimulations.$inferInsert;

// Quotations
export const quotations = mysqlTable("quotations", {
  id: int("id").autoincrement().primaryKey(),
  quotationNumber: varchar("quotationNumber", { length: 255 })
    .unique()
    .notNull(),
  institutionalAccountId: int("institutionalAccountId").notNull(),
  userId: int("userId").notNull(),
...
export const trainingAttendance = mysqlTable("trainingAttendance", {
  ...
  simulationCompetencyPassed: boolean("simulationCompetencyPassed").default(
    false
  ),
...
export const iersCompetencyRecords = mysqlTable("iersCompetencyRecords", {
  ...
  competencyStatus: mysqlEnum("competencyStatus", [
    "pending",
    "attended",
    "absent",
    "cancelled",
...
export type InsertIersCompetencyRecord =
  typeof iersCompetencyRecords.$inferInsert;
...
// standing permission.
export const phase3CrossFacilityApprovals = mysqlTable(
  "phase3CrossFacilityApprovals",
  {
    id: int("id").autoincrement().primaryKey(),
    staffMemberId: int("staffMemberId").notNull(),
...
export const instructorMentorshipGroups = mysqlTable(
...
export const institutionalActionLogs = mysqlTable("institutionalActionLogs", {
  ...
  status: mysqlEnum("status", ["open", "in_progress", "completed"])
    .default("open")
    .notNull(),
...
export type InstitutionalActionLog =
  typeof institutionalActionLogs.$inferSelect;
export type InsertInstitutionalActionLog =
  typeof institutionalActionLogs.$inferInsert;
...
export type InsertInstitutionalAnalytics =
  typeof institutionalAnalytics.$inferInsert;
...
export const impactMetrics = mysqlTable("impactMetrics", {
  ...
  viralCoefficient: decimal("viralCoefficient", {
    precision: 5,
    scale: 2,
  }).default("0"),
  timestamp: timestamp("timestamp").defaultNow(),
...
export const providerPerformanceMetrics = mysqlTable(
  "providerPerformanceMetrics",
  {
    ...
    diagnosticAccuracy: decimal("diagnosticAccuracy", {
      precision: 5,
      scale: 2,
    }).default("0"), // 0-100%
    avgDecisionTime: int("avgDecisionTime"), // seconds
    protocolAdherence: decimal("protocolAdherence", {
      precision: 5,
      scale: 2,
    }).default("0"), // 0-100%
    patientSurvivalRate: decimal("patientSurvivalRate", {
      precision: 5,
      scale: 2,
    }).default("0"), // 0-100%
...
export type ProviderPerformanceMetric =
  typeof providerPerformanceMetrics.$inferSelect;
export type InsertProviderPerformanceMetric =
  typeof providerPerformanceMetrics.$inferInsert;
...
export const cprEvents = mysqlTable(
  "cprEvents",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    sessionIdempotencyUnique: uniqueIndex(
      "cprEvents_session_idempotency_unique"
    ).on(table.cprSessionId, table.idempotencyKey),
  })
);
 ...
 */
export const cprEventLinks = mysqlTable(
  "cprEventLinks",
  {
    id: int("id").autoincrement().primaryKey(),
    activationEventId: int("activationEventId").notNull(),
    ...
    linkStatus: mysqlEnum("linkStatus", [
      "active",
      "outcome_recorded",
      "debrief_pending",
      "closed",
  ...
  table => ({
    activationUnique: uniqueIndex("cprEventLinks_activation_unique").on(
      table.activationEventId
    ),
    cprSessionUnique: uniqueIndex("cprEventLinks_cpr_session_unique").on(
      table.cprSessionId
    ),
    institutionStatusIndex: index("cprEventLinks_institution_status_idx").on(
      table.institutionalAccountId,
      table.linkStatus
    ),
  })
 ...
 */
export const cprCareSignalLinks = mysqlTable(
  "cprCareSignalLinks",
  {
    id: int("id").autoincrement().primaryKey(),
    cprSessionId: int("cprSessionId").notNull(),
    ...
    institutionalAccountId: int("institutionalAccountId"),
    linkedByUserId: int("linkedByUserId").notNull(),
    relationship: mysqlEnum("relationship", ["post_event_prompt", "manual"])
      .notNull()
      .default("post_event_prompt"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    cprSessionIndex: index("cprCareSignalLinks_cpr_session_idx").on(
      table.cprSessionId
    ),
    activationIndex: index("cprCareSignalLinks_activation_idx").on(
      table.activationEventId
    ),
  })
);
...
export type InsertEmergencyMedication =
  typeof emergencyMedications.$inferInsert;
...
export type InsertProtocolAdherenceLog =
  typeof protocolAdherenceLog.$inferInsert;
...
export type InsertProtocolDecisionPoint =
  typeof protocolDecisionPoints.$inferInsert;
...
export type ProtocolRecommendation =
  typeof protocolRecommendations.$inferSelect;
export type InsertProtocolRecommendation =
  typeof protocolRecommendations.$inferInsert;
...
export const symptoms = mysqlTable("symptoms", {
  ...
  severity: mysqlEnum("severity", ["mild", "moderate", "severe"]).default(
    "mild"
  ),
...
export type ConditionSymptomMapping =
  typeof conditionSymptomMapping.$inferSelect;
export type InsertConditionSymptomMapping =
  typeof conditionSymptomMapping.$inferInsert;
...
export const diagnosisAccuracy = mysqlTable("diagnosisAccuracy", {
  ...
  averageConfidence: decimal("averageConfidence", {
    precision: 5,
    scale: 2,
  }).default("0"),
  period: mysqlEnum("period", ["all_time", "monthly", "quarterly"]).default(
    "all_time"
  ),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow(),
});
...
export const differentialDiagnosisScores = mysqlTable(
  "differentialDiagnosisScores",
  {
    ...
    vitalSignMatch: decimal("vitalSignMatch", {
      precision: 5,
      scale: 2,
    }).default("0"), // 0-100
...
export type DifferentialDiagnosisScore =
  typeof differentialDiagnosisScores.$inferSelect;
export type InsertDifferentialDiagnosisScore =
  typeof differentialDiagnosisScores.$inferInsert;
...
export const investigations = mysqlTable("investigations", {
  ...
  patientId: int("patientId").notNull(),
  providerId: int("providerId").notNull(),
  investigationType: mysqlEnum("investigationType", [
    "lab",
    "imaging",
    "other",
  ]).notNull(),
...
export type InsertInvestigationResult =
  typeof investigationResults.$inferInsert;
...
export type InsertInvestigationAnalysis =
  typeof investigationAnalysis.$inferInsert;
...
export type InsertInvestigationHistory =
  typeof investigationHistory.$inferInsert;
...
export type InsertPerformanceHistoryRecord =
  typeof performanceHistory.$inferInsert;
...
export const teamPerformance = mysqlTable("teamPerformance", {
  ...
  averagePerformanceScore: decimal("averagePerformanceScore", {
    precision: 5,
    scale: 2,
  }).default("0"),
  totalPatientsServed: int("totalPatientsServed").default(0),
...
export type InsertParentSafeTruthEvent =
  typeof parentSafeTruthEvents.$inferInsert;
...
export const parentSafeTruthSubmissions = mysqlTable(
  "parentSafeTruthSubmissions",
  {
    ...
    childOutcome: mysqlEnum("childOutcome", [
      "discharged",
      "referred",
      "passed-away",
    ]).notNull(),
...
export type ParentSafeTruthSubmission =
  typeof parentSafeTruthSubmissions.$inferSelect;
export type InsertParentSafeTruthSubmission =
  typeof parentSafeTruthSubmissions.$inferInsert;
...
export const safeTruthSubmissions = mysqlTable("safeTruthSubmissions", {
  ...
  observerClass: varchar("observer_class", { length: 16 })
    .default("CAREGIVER")
    .notNull(),
  ...
  conditionCategory: varchar("condition_category", { length: 64 }).notNull(),
  outcomeCategory: varchar("outcome_category", { length: 64 }).notNull(),
  isCaseLinkageConsented: boolean("is_case_linkage_consented")
    .default(false)
    .notNull(),
   ...
   */
  eventCodeResolvedCareSignalEventId: int(
    "event_code_resolved_care_signal_event_id"
  ),

  // ── §2.4 Journey Stage 1 — Before Seeking Care ──────────────────────────
  symptomOnsetDaysAgo: varchar("symptom_onset_days_ago", {
    length: 32,
  }).notNull(),
  ...
  adviceReceivedBeforeFacility: text(
    "advice_received_before_facility"
  ).notNull(),
  ...
  travelTimeToFirstFacility: varchar("travel_time_to_first_facility", {
    length: 32,
  }).notNull(),
  costBarrierOccurred: boolean("cost_barrier_occurred").notNull(),
  costBarrierDetails: text("cost_barrier_details"),
  facilitiesVisitedCount: varchar("facilities_visited_count", {
    length: 64,
  }).notNull(),
...
export type InsertSafeTruthSubmission =
  typeof safeTruthSubmissions.$inferInsert;
...
export const safeTruthFacilityVisits = mysqlTable("safeTruthFacilityVisits", {
  ...
  visitFacilityIsFinal: boolean("visit_facility_is_final")
    .default(false)
    .notNull(),
...
export type SafeTruthFacilityVisit =
  typeof safeTruthFacilityVisits.$inferSelect;
export type InsertSafeTruthFacilityVisit =
  typeof safeTruthFacilityVisits.$inferInsert;
...
export type SafeTruthDisclaimerAck =
  typeof safeTruthDisclaimerAcks.$inferSelect;
export type InsertSafeTruthDisclaimerAck =
  typeof safeTruthDisclaimerAcks.$inferInsert;
...
export const hospitalImprovementMetrics = mysqlTable(
  "hospitalImprovementMetrics",
  {
    ...
    avgArrivalToDoctorDelay: decimal("avgArrivalToDoctorDelay", {
      precision: 5,
      scale: 1,
    }),
    avgDoctorToInterventionDelay: decimal("avgDoctorToInterventionDelay", {
      precision: 5,
      scale: 1,
    }),
    communicationGapPercentage: decimal("communicationGapPercentage", {
      precision: 5,
      scale: 1,
    }),
    monitoringGapPercentage: decimal("monitoringGapPercentage", {
      precision: 5,
      scale: 1,
    }),
    improvementTrend: mysqlEnum("improvementTrend", [
      "improving",
      "stable",
      "declining",
    ]),
...
export type HospitalImprovementMetrics =
  typeof hospitalImprovementMetrics.$inferSelect;
export type InsertHospitalImprovementMetrics =
  typeof hospitalImprovementMetrics.$inferInsert;
...
export const chatMessages = mysqlTable("chatMessages", {
  ...
  content: text("content").notNull(),
  messageType: mysqlEnum("messageType", ["text", "file", "system"]).default(
    "text"
  ),
  isRead: boolean("isRead").default(false),
  readAt: timestamp("readAt"),
...
export const supportAgents = mysqlTable("supportAgents", {
  ...
  status: mysqlEnum("status", ["available", "busy", "offline"]).default(
    "offline"
  ),
...
export const chatAnalytics = mysqlTable("chatAnalytics", {
  ...
  avgResolutionTime: int("avgResolutionTime"), // in minutes
  avgCustomerSatisfaction: decimal("avgCustomerSatisfaction", {
    precision: 3,
    scale: 2,
  }), // 0-5 scale
...
export const guidelines = mysqlTable("guidelines", {
  ...
  status: mysqlEnum("status", ["current", "superseded", "withdrawn"])
    .default("current")
    .notNull(),
  category: mysqlEnum("category", [
    "cardiac_arrest",
...
export const protocolGuidelines = mysqlTable("protocolGuidelines", {
  ...
  relevance: mysqlEnum("relevance", ["primary", "secondary", "reference"])
    .default("primary")
    .notNull(),
...
export const protocolStatus = mysqlTable("protocolStatus", {
  ...
  priority: mysqlEnum("priority", ["urgent", "high", "normal", "low"])
    .default("normal")
    .notNull(),
  notes: text("notes"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
...
export const clinicalReferrals = mysqlTable("clinicalReferrals", {
  ...
  urgency: mysqlEnum("urgency", ["routine", "urgent", "emergency"])
    .default("routine")
    .notNull(),
  reason: text("reason").notNull(),
...
export const resusGPSSessions = mysqlTable("resusGPSSessions", {
  ...
  status: mysqlEnum("status", ["ongoing", "completed", "abandoned"]).default(
    "ongoing"
  ),
...
export const fellowshipGraceUsage = mysqlTable("fellowshipGraceUsage", {
   ...
   * Care Signal grace.
   */
  requirementType: mysqlEnum("requirementType", ["care_signal", "cpd"])
    .default("care_signal")
    .notNull(),
...
export type InsertFellowshipGraceUsage =
  typeof fellowshipGraceUsage.$inferInsert;
...
export type InsertFellowshipStreakReset =
  typeof fellowshipStreakResets.$inferInsert;
...
export type InsertProviderSampleHistory =
  typeof providerSampleHistory.$inferInsert;
...
export const userNotificationPreferences = mysqlTable(
  ...
  table => ({
    userIdUnique: uniqueIndex("userNotificationPreferences_userId_unique").on(
      table.userId
    ),
  })
);
...
export const contentSafetyReports = mysqlTable("contentSafetyReports", {
  ...
  message: text("message").notNull(),
  status: mysqlEnum("status", ["open", "reviewed", "closed"])
    .default("open")
    .notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
});
...
export type InsertContentSafetyReport =
  typeof contentSafetyReports.$inferInsert;
...
export const platformFeedbackTickets = mysqlTable("platformFeedbackTickets", {
  ...
  status: mysqlEnum("status", [
    ...
    .default("open")
    .notNull(),
  priority: mysqlEnum("priority", ["normal", "safety"])
    .default("normal")
    .notNull(),
...
export type PlatformFeedbackTicket =
  typeof platformFeedbackTickets.$inferSelect;
export type InsertPlatformFeedbackTicket =
  typeof platformFeedbackTickets.$inferInsert;
...
export type InsertAhaPracticeLabAttempt =
...
export const cpdEvents = mysqlTable("cpdEvents", {
  ...
  audienceScope: mysqlEnum("audienceScope", [
    "facility_wide",
    "nursing_wide",
    "clinical",
    "m_and_m",
...
export const cpdEventCoPresenters = mysqlTable(
  "cpdEventCoPresenters",
  {
    ...
    institutionalAccountId: int("institutionalAccountId").notNull(),
    userId: int("userId"),
    participantType: mysqlEnum("participantType", ["institution_member", "guest"])
      .default("institution_member")
      .notNull(),
  ...
  table => ({
    ...
    institutionIndex: index("cpd_event_co_presenters_institution_idx").on(
      table.institutionalAccountId
    ),
  })
);
export type CpdEventCoPresenter = typeof cpdEventCoPresenters.$inferSelect;
export type InsertCpdEventCoPresenter =
  typeof cpdEventCoPresenters.$inferInsert;
...
export const cpdAttendees = mysqlTable("cpdAttendees", {
  ...
  attendanceType: mysqlEnum("attendanceType", [
    ...
    .default("primary_facility")
    .notNull(),
  roleInEvent: mysqlEnum("roleInEvent", [
    "attendee",
    "presenter",
    "co_presenter",
    "moderator",
    ...
    .default("attendee")
    .notNull(),
  checkInPunctuality: mysqlEnum("checkInPunctuality", [
    "on_time",
    "late_15m",
    "late_30m+",
  ])
...
export const kbFailureModes = mysqlTable("kb_failure_modes", {
  ...
  failureModeCode: varchar("failure_mode_code", { length: 64 })
    .notNull()
    .unique(),
  ...
  taxonomyVersion: varchar("taxonomy_version", { length: 16 })
    .default("1.0")
    .notNull(),
  isActive: boolean("is_active").default(true).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const kbSuccessFactors = mysqlTable("kb_success_factors", {
  id: varchar("id", { length: 36 }).primaryKey(),
  successFactorCode: varchar("success_factor_code", { length: 64 })
    .notNull()
    .unique(),
...
export const kbPatterns = mysqlTable("kb_patterns", {
  ...
  supportingObservationCount: int("supporting_observation_count")
    .default(0)
    .notNull(),
  firstDetectedAt: timestamp("first_detected_at"),
  lastConfirmedAt: timestamp("last_confirmed_at"),
  trendDirection: mysqlEnum("trend_direction", [
    "INCREASING",
    "DECREASING",
    "STABLE",
    "INSUFFICIENT_DATA",
  ...
  taxonomyVersion: varchar("taxonomy_version", { length: 16 })
    .default("1.0")
    .notNull(),
  knowledgeStatus: mysqlEnum("knowledge_status", [
    "ACTIVE",
    "UNDER_REVIEW",
    "RETIRED",
  ])
...
export const kbPatternObservations = mysqlTable("kb_pattern_observations", {
  ...
  taxonomyVersionAtLink: varchar("taxonomy_version_at_link", { length: 16 })
    .default("1.0")
    .notNull(),
});
export type KbPatternObservation = typeof kbPatternObservations.$inferSelect;
export type InsertKbPatternObservation =
  typeof kbPatternObservations.$inferInsert;

export const kbEvidenceLinks = mysqlTable("kb_evidence_links", {
  id: varchar("id", { length: 36 }).primaryKey(),
  patternId: varchar("pattern_id", { length: 36 }).notNull(),
  evidenceSourceType: mysqlEnum("evidence_source_type", [
    "OBSERVATIONAL",
    "EXPERIMENTAL",
    "EXPERT",
    "ADAPTIVE",
  ...
  evidenceDirection: mysqlEnum("evidence_direction", [
    "SUPPORTS",
    "CHALLENGES",
    "NEUTRAL",
    "SUPERSEDES",
  ...
  lmicApplicability: mysqlEnum("lmic_applicability", [
    "HIGH",
    "MODERATE",
    "LOW",
    "NOT_ASSESSED",
...
export const kbRecommendations = mysqlTable("kb_recommendations", {
  ...
  confidenceLevelAtGeneration: varchar("confidence_level_at_generation", {
    length: 64,
  }).notNull(),
  ...
  governanceStatus: mysqlEnum("governance_status", [
    "PENDING",
    "APPROVED",
    "REJECTED",
    "SUPERSEDED",
...
export const kbInterventions = mysqlTable("kb_interventions", {
  ...
  interventionScope: mysqlEnum("intervention_scope", [
    "ED_ONLY",
    "WARD",
    "HOSPITAL_WIDE",
    "NETWORK",
  ...
  interventionStatus: mysqlEnum("intervention_status", [
    "PLANNED",
    "IN_PROGRESS",
    "COMPLETED",
    "ABANDONED",
...
export const kbImplementations = mysqlTable("kb_implementations", {
  ...
  actualScope: mysqlEnum("actual_scope", [
    "ED_ONLY",
    "WARD",
    "HOSPITAL_WIDE",
    "NETWORK",
  ...
  implementationFidelity: mysqlEnum("implementation_fidelity", [
    "HIGH",
    "PARTIAL",
    "LOW",
    "NOT_IMPLEMENTED",
  ...
  outcomeLabel: mysqlEnum("outcome_label", [
    "IMPROVED",
    "NO_IMPROVEMENT",
    "WORSENED",
    "EVALUATION_PENDING",
  ...
  confidenceImpactApplied: boolean("confidence_impact_applied")
    .default(false)
    .notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  createdBy: varchar("created_by", { length: 36 }).notNull(),
...
export const kbReviewSchedule = mysqlTable("kb_review_schedule", {
  ...
  reviewType: mysqlEnum("review_type", [
    "SCHEDULED",
    "TRIGGERED_BY_NEW_EVIDENCE",
    "TRIGGERED_BY_CONCEPT_DRIFT",
    "MANUAL",
  ]).notNull(),
...
export const kbContentVersions = mysqlTable("kb_content_versions", {
  ...
  knowledgeStewardshipApprovedBy: varchar("knowledge_stewardship_approved_by", {
    length: 36,
  }).notNull(),
  knowledgeStewardshipApprovedAt: timestamp(
    "knowledge_stewardship_approved_at"
  ).notNull(),
 ...
 */
export const careSignalRawNarrativeAudit = mysqlTable(
  "care_signal_raw_narrative_audit",
  {
    id: int("id").autoincrement().primaryKey(),
...
export type CareSignalRawNarrativeAuditRow =
  typeof careSignalRawNarrativeAudit.$inferSelect;
...
export const institutionCpdDepartmentResolutions = mysqlTable(
  "institution_cpd_department_resolutions",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionalAccountId: int("institutional_account_id").notNull(),
    cpdAttendeeId: int("cpd_attendee_id").notNull(),
    recordedDepartment: varchar("recorded_department", {
      length: 256,
    }).notNull(),
    facilityDepartmentId: int("facility_department_id"),
    status: mysqlEnum("status", ["resolved", "deferred", "dismissed", "open"])
      .default("open")
      .notNull(),
  ...
  table => ({
    attendeeUnique: uniqueIndex("inst_cpd_dept_resolution_attendee_uq").on(
      table.institutionalAccountId,
      table.cpdAttendeeId
    ),
    institutionStatusIndex: index(
      "inst_cpd_dept_resolution_inst_status_idx"
    ).on(table.institutionalAccountId, table.status),
  })
);
export type InstitutionCpdDepartmentResolution =
  typeof institutionCpdDepartmentResolutions.$inferSelect;
export type InsertInstitutionCpdDepartmentResolution =
  typeof institutionCpdDepartmentResolutions.$inferInsert;

// 2. Department Mapping to Poles
export const facilityDepartments = mysqlTable(
  ...
  table => ({
    iersPoleRequirementIndex: index("facility_depts_iers_pole_req_idx").on(
      table.institutionId,
      table.isActive,
      table.requiresPole,
      table.poleId
...
export const institutionEducationCoordinators = mysqlTable(
  ...
  table => ({
    departmentIndex: index(
      "institution_education_coordinators_department_idx"
    ).on(
      table.institutionalAccountId,
      table.departmentId,
      table.assignmentStatus
    ),
    userIndex: index("institution_education_coordinators_user_idx").on(
      table.institutionalAccountId,
      table.userId,
      table.assignmentStatus
    ),
...
export type InstitutionEducationCoordinator =
  typeof institutionEducationCoordinators.$inferSelect;
export type InsertInstitutionEducationCoordinator =
  typeof institutionEducationCoordinators.$inferInsert;

/** Facility, department, or individual learning expectations for a bounded reporting period. */
export const institutionLearningTargets = mysqlTable(
  "institutionLearningTargets",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionalAccountId: int("institutionalAccountId").notNull(),
    targetScope: mysqlEnum("targetScope", [
      "facility",
      "department",
      "individual",
    ]).notNull(),
    ...
    courseProgramType: mysqlEnum("courseProgramType", [
      "bls",
      "acls",
      "pals",
      "nrp",
    ...
    coursePhase: mysqlEnum("coursePhase", [
      "cognitive",
      "phase_2",
      "phase_3",
      "completed",
    ]),
    status: mysqlEnum("status", ["active", "archived", "superseded"])
      .default("active")
      .notNull(),
  ...
  table => ({
    periodIndex: index("institution_learning_targets_period_idx").on(
      table.institutionalAccountId,
      table.status,
      table.periodStart,
      table.periodEnd
    ),
    scopeIndex: index("institution_learning_targets_scope_idx").on(
      table.institutionalAccountId,
      table.targetScope,
      table.departmentId,
      table.userId
...
export const professionalCredentials = mysqlTable(
  ...
  table => ({
    userIndex: index("professional_credentials_user_idx").on(
      table.userId,
      table.status
    ),
    expiryIndex: index("professional_credentials_expiry_idx").on(
      table.status,
      table.expiresAt
    ),
    sourceIndex: index("professional_credentials_source_idx").on(
      table.sourceType,
      table.sourceRecordType,
      table.sourceRecordId
    ),
    sourceRecordUnique: uniqueIndex(
      "professional_credentials_source_record_uq"
    ).on(
      table.userId,
...
export type ProfessionalCredential =
  typeof professionalCredentials.$inferSelect;
export type InsertProfessionalCredential =
  typeof professionalCredentials.$inferInsert;

/** Idempotent reminder delivery ledger for credential expiry notifications. */
export const professionalCredentialReminderEvents = mysqlTable(
  "professionalCredentialReminderEvents",
  {
    id: int("id").autoincrement().primaryKey(),
    credentialId: int("credentialId").notNull(),
    userId: int("userId").notNull(),
    reminderStage: mysqlEnum("reminderStage", [
      "three_months",
      "two_months",
      "one_month",
      "weekly_overdue",
  ...
  table => ({
    dedupeUnique: uniqueIndex("professional_credential_reminder_dedupe_uq").on(
      table.credentialId,
      table.reminderStage,
      table.duePeriod,
      table.channel
    ),
    userIndex: index("professional_credential_reminder_user_idx").on(
      table.userId,
      table.duePeriod
    ),
  })
);
export type ProfessionalCredentialReminderEvent =
  typeof professionalCredentialReminderEvents.$inferSelect;
export type InsertProfessionalCredentialReminderEvent =
  typeof professionalCredentialReminderEvents.$inferInsert;

/** One active Departmental Head appointment per institution and canonical department. */
export const institutionDepartmentHeads = mysqlTable(
  ...
  table => ({
    departmentIndex: index("institution_department_heads_department_idx").on(
      table.institutionalAccountId,
      table.departmentId,
      table.assignmentStatus
    ),
    userIndex: index("institution_department_heads_user_idx").on(
      table.institutionalAccountId,
      table.userId,
      table.assignmentStatus
    ),
    activeAssignmentUnique: uniqueIndex(
      "institution_department_heads_active_uq"
    ).on(table.activeAssignmentKey),
  })
);
export type InstitutionDepartmentHead =
  typeof institutionDepartmentHeads.$inferSelect;
export type InsertInstitutionDepartmentHead =
  typeof institutionDepartmentHeads.$inferInsert;

/** Append-only history for Departmental Head assignment, reassignment, and ending. */
export const institutionDepartmentHeadEvents = mysqlTable(
  ...
  table => ({
    assignmentIndex: index(
      "institution_department_head_events_assignment_idx"
    ).on(table.assignmentId, table.createdAt),
    institutionIndex: index(
      "institution_department_head_events_institution_idx"
    ).on(table.institutionalAccountId, table.createdAt),
  })
);
export type InstitutionDepartmentHeadEvent =
  typeof institutionDepartmentHeadEvents.$inferSelect;
export type InsertInstitutionDepartmentHeadEvent =
  typeof institutionDepartmentHeadEvents.$inferInsert;

/** Current review state for one normalized historic CPD department label per institution. */
export const institutionDepartmentReconciliations = mysqlTable(
  "institution_department_reconciliations",
  {
    ...
    status: mysqlEnum("status", ["open", "mapped", "deferred", "dismissed"])
      .default("open")
      .notNull(),
    suggestedCatalogLabel: varchar("suggested_catalog_label", { length: 256 }),
    suggestionConfidence: mysqlEnum("suggestion_confidence", [
      "none",
      "exact",
      "alias",
      "ambiguous",
  ...
  table => ({
    institutionLabelUnique: uniqueIndex(
      "inst_dept_recon_institution_label_uq"
    ).on(table.institutionalAccountId, table.normalizedLabel),
    institutionStatusIndex: index("inst_dept_recon_inst_status_idx").on(
      table.institutionalAccountId,
      table.status
    ),
  })
);
export type InstitutionDepartmentReconciliation =
  typeof institutionDepartmentReconciliations.$inferSelect;
export type InsertInstitutionDepartmentReconciliation =
  typeof institutionDepartmentReconciliations.$inferInsert;

/** Append-only record of department mapping, review, backfill, and pole-eligibility decisions. */
export const institutionDepartmentAuditEvents = mysqlTable(
  ...
  table => ({
    institutionEventIndex: index("inst_dept_audit_inst_created_idx").on(
      table.institutionalAccountId,
      table.createdAt
    ),
    reconciliationEventIndex: index("inst_dept_audit_recon_created_idx").on(
      table.reconciliationId,
      table.createdAt
    ),
    departmentEventIndex: index("inst_dept_audit_dept_created_idx").on(
      table.departmentId,
      table.createdAt
    ),
  })
);
export type InstitutionDepartmentAuditEvent =
  typeof institutionDepartmentAuditEvents.$inferSelect;
export type InsertInstitutionDepartmentAuditEvent =
  typeof institutionDepartmentAuditEvents.$inferInsert;

/** Exactly one standing Emergency Response Coordinator (ERCo) assignment per department. */
export const institutionDepartmentResponseCoordinators = mysqlTable(
  ...
  table => ({
    institutionDepartmentUnique: uniqueIndex(
      "institution_department_erc_unique"
    ).on(table.institutionId, table.departmentId),
    coordinatorIndex: index("institution_erc_coordinator_idx").on(
      table.institutionId,
      table.coordinatorUserId
    ),
    backupIndex: index("institution_erc_backup_idx").on(
      table.institutionId,
      table.backupUserId
    ),
    statusIndex: index("institution_erc_status_idx").on(
      table.institutionId,
      table.assignmentStatus
    ),
  })
);
export type InstitutionDepartmentResponseCoordinator =
  typeof institutionDepartmentResponseCoordinators.$inferSelect;
export type InsertInstitutionDepartmentResponseCoordinator =
  typeof institutionDepartmentResponseCoordinators.$inferInsert;

export const institutionDepartmentResponseCoordinatorEvents = mysqlTable(
  ...
  table => ({
    assignmentIndex: index("institution_erc_event_assignment_idx").on(
      table.assignmentId,
      table.createdAt
    ),
    institutionIndex: index("institution_erc_event_institution_idx").on(
      table.institutionId,
      table.createdAt
    ),
  })
);
export type InstitutionDepartmentResponseCoordinatorEvent =
  typeof institutionDepartmentResponseCoordinatorEvents.$inferSelect;
export type InsertInstitutionDepartmentResponseCoordinatorEvent =
  typeof institutionDepartmentResponseCoordinatorEvents.$inferInsert;
 ...
 */
export const monthlyUtlRotations = mysqlTable(
  ...
  table => ({
    institutionDepartmentMonthUnique: uniqueIndex(
      "monthly_utl_rotation_unique"
    ).on(table.institutionId, table.departmentId, table.monthStart),
    departmentMonthIndex: index("monthly_utl_rotation_department_month_idx").on(
      table.departmentId,
      table.monthStart
    ),
    providerIndex: index("monthly_utl_rotation_provider_idx").on(
      table.institutionId,
      table.providerUserId
    ),
  })
...
export const institutionShiftTemplates = mysqlTable(
  ...
  table => ({
    institutionNameUnique: uniqueIndex(
      "institution_shift_templates_institution_name_unique"
    ).on(table.institutionId, table.templateName),
    institutionOrderIndex: index(
      "institution_shift_templates_institution_order_idx"
    ).on(table.institutionId, table.sortOrder),
  })
);
export type InstitutionShiftTemplate =
  typeof institutionShiftTemplates.$inferSelect;
export type InsertInstitutionShiftTemplate =
  typeof institutionShiftTemplates.$inferInsert;
...
export const shiftUtlRosters = mysqlTable("shift_utl_rosters", {
  ...
  status: mysqlEnum("status", ["active", "completed", "absent"])
    .default("active")
    .notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
...
export const iersShiftTeams = mysqlTable(
  "iers_shift_teams",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionId: int("institution_id").notNull(),
  ...
  table => ({
    institutionShiftIndex: index("iers_shift_teams_institution_shift_idx").on(
      table.institutionId,
      table.shiftDate,
      table.shiftType
    ),
    poleShiftIndex: index("iers_shift_teams_pole_shift_idx").on(
      table.poleId,
      table.shiftDate,
      table.shiftType,
      table.teamVersion
...
export const iersShiftRoleAssignments = mysqlTable(
  ...
  table => ({
    teamProviderIndex: index(
      "iers_shift_role_assignments_team_provider_idx"
    ).on(table.teamId, table.providerUserId),
    institutionProviderIndex: index(
      "iers_shift_role_assignments_institution_provider_idx"
    ).on(table.institutionId, table.providerUserId, table.assignmentStatus),
    teamRoleIndex: index("iers_shift_role_assignments_team_role_idx").on(
      table.teamId,
      table.roleScope,
      table.roleKey
    ),
...
export type IersShiftRoleAssignment =
  typeof iersShiftRoleAssignments.$inferSelect;
export type InsertIersShiftRoleAssignment =
  typeof iersShiftRoleAssignments.$inferInsert;

/** A provider's proposed alternative role awaiting ERTL decision and provider acceptance. */
export const iersShiftRoleRecommendations = mysqlTable(
  ...
  table => ({
    assignmentStatusIndex: index(
      "iers_shift_role_recommendations_assignment_status_idx"
    ).on(table.assignmentId, table.status),
    teamStatusIndex: index(
      "iers_shift_role_recommendations_team_status_idx"
    ).on(table.teamId, table.status),
  })
);
export type IersShiftRoleRecommendation =
  typeof iersShiftRoleRecommendations.$inferSelect;
export type InsertIersShiftRoleRecommendation =
  typeof iersShiftRoleRecommendations.$inferInsert;

/** Append-only role assignment events for audit, dispute resolution, and learning. */
export const iersShiftRoleEvents = mysqlTable(
  ...
  table => ({
    assignmentOccurredIndex: index(
      "iers_shift_role_events_assignment_occurred_idx"
    ).on(table.assignmentId, table.occurredAt),
    institutionOccurredIndex: index(
      "iers_shift_role_events_institution_occurred_idx"
...
export const iersReadinessTemplates = mysqlTable(
  "iers_readiness_templates",
  {
    ...
    status: mysqlEnum("status", ["draft", "approved", "active", "superseded"])
      .default("active")
      .notNull(),
    approvedByUserId: int("approved_by_user_id"),
  ...
  table => ({
    institutionStatusIndex: index(
      "iers_readiness_templates_institution_status_idx"
    ).on(table.institutionId, table.status),
    institutionVersionUnique: uniqueIndex(
      "iers_readiness_templates_institution_version_unique"
    ).on(table.institutionId, table.templateVersion),
  })
);
export type IersReadinessTemplate = typeof iersReadinessTemplates.$inferSelect;
export type InsertIersReadinessTemplate =
  typeof iersReadinessTemplates.$inferInsert;

/** Controlled item taxonomy for an approved readiness template. */
export const iersReadinessTemplateItems = mysqlTable(
  "iers_readiness_template_items",
  {
    ...
    requiresExpiryCheck: boolean("requires_expiry_check")
      .default(false)
      .notNull(),
    requiresFunctionCheck: boolean("requires_function_check")
      .default(false)
      .notNull(),
    sortOrder: int("sort_order").default(0).notNull(),
    isActive: boolean("is_active").default(true).notNull(),
  ...
  table => ({
    templateCodeUnique: uniqueIndex(
      "iers_readiness_template_items_code_unique"
    ).on(table.templateId, table.itemCode),
    templateOrderIndex: index("iers_readiness_template_items_order_idx").on(
      table.templateId,
      table.sortOrder
    ),
  })
);
export type IersReadinessTemplateItem =
  typeof iersReadinessTemplateItems.$inferSelect;
export type InsertIersReadinessTemplateItem =
  typeof iersReadinessTemplateItems.$inferInsert;

/** One UTL physical readiness check against a fixed template version. */
export const iersUtlReadinessChecks = mysqlTable(
  ...
  table => ({
    institutionCheckedIndex: index(
      "iers_utl_readiness_checks_institution_checked_idx"
    ).on(table.institutionId, table.checkedAt),
    teamStatusIndex: index("iers_utl_readiness_checks_team_status_idx").on(
      table.teamId,
      table.status
    ),
    idempotencyUnique: uniqueIndex(
      "iers_utl_readiness_checks_idempotency_unique"
    ).on(table.checkedByUserId, table.idempotencyKey),
  })
);
export type IersUtlReadinessCheck = typeof iersUtlReadinessChecks.$inferSelect;
export type InsertIersUtlReadinessCheck =
  typeof iersUtlReadinessChecks.$inferInsert;

/** Item-level observation for one UTL readiness check. */
export const iersUtlReadinessCheckItems = mysqlTable(
  ...
  table => ({
    checkItemUnique: uniqueIndex(
      "iers_utl_readiness_check_items_check_item_unique"
    ).on(table.checkId, table.templateItemId),
    checkStatusIndex: index(
      "iers_utl_readiness_check_items_check_status_idx"
    ).on(table.checkId, table.itemStatus),
  })
);
export type IersUtlReadinessCheckItem =
  typeof iersUtlReadinessCheckItems.$inferSelect;
export type InsertIersUtlReadinessCheckItem =
  typeof iersUtlReadinessCheckItems.$inferInsert;

/** Immutable activation-time copy of the planned team and role assignments. */
export const iersActivationTeamSnapshots = mysqlTable(
  ...
  table => ({
    activationProviderUnique: uniqueIndex(
      "iers_activation_team_snapshots_provider_unique"
    ).on(table.activationEventId, table.providerUserId, table.roleKey),
    activationIndex: index("iers_activation_team_snapshots_activation_idx").on(
      table.activationEventId,
      table.teamId
    ),
  })
);
export type IersActivationTeamSnapshot =
  typeof iersActivationTeamSnapshots.$inferSelect;
export type InsertIersActivationTeamSnapshot =
  typeof iersActivationTeamSnapshots.$inferInsert;

/** Named, activation-linked, role-specific operational observation. */
export const iersTargetedRoleReports = mysqlTable(
  "iers_targeted_role_reports",
  {
    ...
    reportPhase: mysqlEnum("report_phase", [
      "recognition",
      "activation",
      "response",
      "stabilization",
    ...
    noPatientIdentifiersAcknowledged: boolean(
      ...
      .notNull()
      .default(false),
    submissionState: mysqlEnum("submission_state", [
      "submitted",
      "accepted",
      "returned",
      "superseded",
  ...
  table => ({
    activationSubmittedIndex: index(
      "iers_targeted_role_reports_activation_submitted_idx"
    ).on(table.activationEventId, table.submittedAt),
    providerSubmittedIndex: index(
      "iers_targeted_role_reports_provider_submitted_idx"
    ).on(table.providerUserId, table.submittedAt),
    idempotencyUnique: uniqueIndex(
      "iers_targeted_role_reports_idempotency_unique"
    ).on(table.providerUserId, table.idempotencyKey),
  })
);
export type IersTargetedRoleReport =
  typeof iersTargetedRoleReports.$inferSelect;
export type InsertIersTargetedRoleReport =
  typeof iersTargetedRoleReports.$inferInsert;
...
export type InsertIermsAuditScorecard =
  typeof iermsAuditScorecards.$inferInsert;
...
export const iersEvidenceRecords = mysqlTable(
  ...
  table => ({
    institutionDomainIndex: index(
      "iersEvidenceRecords_institution_domain_idx"
    ).on(table.institutionId, table.domain),
    institutionCriterionIndex: index(
      "iersEvidenceRecords_institution_criterion_idx"
    ).on(table.institutionId, table.criterionCode),
    institutionStatusIndex: index(
      "iersEvidenceRecords_institution_status_idx"
    ).on(table.institutionId, table.status),
  })
);
...
export const iersActionItems = mysqlTable(
  "iers_action_items",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionId: int("institution_id").notNull(),
  ...
  table => ({
    institutionStatusIndex: index("iersActionItems_institution_status_idx").on(
      table.institutionId,
      table.status
    ),
    institutionOwnerIndex: index("iersActionItems_institution_owner_idx").on(
      table.institutionId,
      table.ownerUserId
    ),
    institutionDueDateIndex: index(
      "iersActionItems_institution_due_date_idx"
    ).on(table.institutionId, table.dueDate),
  })
);
...
export const iersDrills = mysqlTable(
  "iers_drills",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionId: int("institution_id").notNull(),
    ...
    noPatientIdentifiersAcknowledged: boolean(
      ...
      .default(false)
      .notNull(),
    noPatientIdentifiersAcknowledgedAt: timestamp(
      "no_patient_identifiers_acknowledged_at"
    ),
    ...
    targetResponseSeconds: int("target_response_seconds")
      .default(180)
      .notNull(),
  ...
  table => ({
    institutionStatusIndex: index("iersDrills_institution_status_idx").on(
      table.institutionId,
      table.status
    ),
    institutionScheduleIndex: index("iersDrills_institution_schedule_idx").on(
      table.institutionId,
      table.scheduledAt
    ),
  })
...
export const iersDrillParticipants = mysqlTable(
  ...
  table => ({
    drillUserUnique: uniqueIndex("iersDrillParticipants_drill_user_unique").on(
      table.drillId,
      table.userId
    ),
    institutionUserIndex: index(
      "iersDrillParticipants_institution_user_idx"
    ).on(table.institutionId, table.userId),
  })
);
export type IersDrillParticipant = typeof iersDrillParticipants.$inferSelect;
export type InsertIersDrillParticipant =
  typeof iersDrillParticipants.$inferInsert;

/** 30/60/90-day IERS implementation milestones with explicit owners and proof. */
export const iersImplementationMilestones = mysqlTable(
  ...
  table => ({
    institutionPhaseUnique: uniqueIndex(
      "iersImplementationMilestones_institution_phase_unique"
    ).on(table.institutionId, table.phaseOrder),
    institutionStatusIndex: index(
      "iersImplementationMilestones_institution_status_idx"
    ).on(table.institutionId, table.status),
  })
);
export type IersImplementationMilestone =
  typeof iersImplementationMilestones.$inferSelect;
export type InsertIersImplementationMilestone =
  typeof iersImplementationMilestones.$inferInsert;

// 7. 90-Day Implementation Tracker
export const iermsImplementationTrackers = mysqlTable(
  "ierms_implementation_trackers",
  {
    id: int("id").autoincrement().primaryKey(),
    institutionId: int("institution_id").notNull(),
    phase1MouStatus: mysqlEnum("phase1_status", [
      "pending",
      "in_progress",
      "completed",
    ])
      .default("pending")
      .notNull(),
    phase2ErtStatus: mysqlEnum("phase2_status", [
      "pending",
      "in_progress",
      "completed",
    ])
      .default("pending")
      .notNull(),
    phase3TrainingStatus: mysqlEnum("phase3_status", [
      "pending",
      "in_progress",
      "completed",
    ])
      .default("pending")
      .notNull(),
    phase4AuditStatus: mysqlEnum("phase4_status", [
      "pending",
      "in_progress",
      "completed",
    ])
...
export type IermsImplementationTracker =
  typeof iermsImplementationTrackers.$inferSelect;
export type InsertIermsImplementationTracker =
  typeof iermsImplementationTrackers.$inferInsert;

/** NERP ACLS pathway enrollment and six-installment ledger. */
export const nerpOfferEnrollments = mysqlTable(
  "nerp_offer_enrollments",
  {
    ...
    status: mysqlEnum("status", ["active", "completed", "cancelled"])
      .default("active")
      .notNull(),
    totalAmountKes: decimal("total_amount_kes", {
      precision: 10,
      scale: 2,
    }).notNull(),
    monthlyInstallmentKes: decimal("monthly_installment_kes", {
      precision: 10,
      scale: 2,
    }).notNull(),
    installmentCount: int("installment_count").notNull(),
    amountPaidKes: decimal("amount_paid_kes", { precision: 10, scale: 2 })
      .default("0.00")
      .notNull(),
  ...
  table => ({
    userOfferUnique: uniqueIndex("nerp_offer_enrollments_user_offer_uq").on(
      table.userId,
      table.offerKey
    ),
    userStatusIndex: index("nerp_offer_enrollments_user_status_idx").on(
      table.userId,
      table.status
    ),
  })
...
export type InsertNerpOfferEnrollment =
  typeof nerpOfferEnrollments.$inferInsert;

/** Links one NERP offer to the existing BLS and ACLS enrollment records. */
export const nerpOfferCourses = mysqlTable(
  "nerp_offer_courses",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    offerProgramUnique: uniqueIndex("nerp_offer_courses_offer_program_uq").on(
      table.nerpOfferEnrollmentId,
      table.programType
    ),
    enrollmentIndex: index("nerp_offer_courses_enrollment_idx").on(
      table.enrollmentId
    ),
  })
);
...
export const nerpOfferExternalVerifications = mysqlTable(
  "nerp_offer_external_verifications",
  {
    id: int("id").autoincrement().primaryKey(),
    nerpOfferEnrollmentId: int("nerp_offer_enrollment_id").notNull(),
    phase: mysqlEnum("phase", ["phase_2", "phase_3"]).notNull(),
    status: mysqlEnum("status", ["verified", "rejected", "revoked"])
      .default("rejected")
      .notNull(),
    completedAt: timestamp("completed_at"),
  ...
  table => ({
    offerPhaseUnique: uniqueIndex(
      "nerp_offer_external_verifications_offer_phase_uq"
    ).on(table.nerpOfferEnrollmentId, table.phase),
    statusIndex: index("nerp_offer_external_verifications_status_idx").on(
      table.status
    ),
  })
);
export type NerpOfferExternalVerification =
  typeof nerpOfferExternalVerifications.$inferSelect;
export type InsertNerpOfferExternalVerification =
  typeof nerpOfferExternalVerifications.$inferInsert;

/** Admin-reviewed external NERP completion case that does not require a NERP offer ledger. */
export const nerpExternalVerificationCases = mysqlTable(
  "nerp_external_verification_cases",
  {
    ...
    candidateType: mysqlEnum("candidate_type", [
      "nerp_nurse",
      "non_nurse_external",
    ])
      .default("nerp_nurse")
    ...
    sourceType: mysqlEnum("source_type", [
      "external_provider_certificate",
      "employer_record",
      "manual_admin_attestation",
      "other",
    ])
      .default("external_provider_certificate")
      .notNull(),
    status: mysqlEnum("status", [
      "open",
      "partially_verified",
  ...
  table => ({
    institutionStatusIndex: index(
      "nerp_external_cases_institution_status_idx"
    ).on(table.institutionalAccountId, table.status),
    candidateEmailIndex: index("nerp_external_cases_candidate_email_idx").on(
      table.candidateEmail
    ),
    userIndex: index("nerp_external_cases_user_idx").on(table.userId),
  })
);
export type NerpExternalVerificationCase =
  typeof nerpExternalVerificationCases.$inferSelect;
export type InsertNerpExternalVerificationCase =
  typeof nerpExternalVerificationCases.$inferInsert;

/** Phase-specific review records for an external NERP completion case. */
export const nerpExternalVerificationPhases = mysqlTable(
  ...
  table => ({
    casePhaseUnique: uniqueIndex(
      "nerp_external_verification_phases_case_phase_uq"
    ).on(table.caseId, table.phase),
    statusIndex: index("nerp_external_verification_phases_status_idx").on(
      table.status
    ),
  })
);
export type NerpExternalVerificationPhase =
  typeof nerpExternalVerificationPhases.$inferSelect;
export type InsertNerpExternalVerificationPhase =
  typeof nerpExternalVerificationPhases.$inferInsert;

/** Append-only audit trail for external NERP cases. */
export const nerpExternalVerificationAuditEvents = mysqlTable(
  ...
  table => ({
    caseCreatedIndex: index(
      "nerp_external_verification_audit_case_created_idx"
    ).on(table.caseId, table.createdAt),
  })
);
export type NerpExternalVerificationAuditEvent =
  typeof nerpExternalVerificationAuditEvents.$inferSelect;
export type InsertNerpExternalVerificationAuditEvent =
  typeof nerpExternalVerificationAuditEvents.$inferInsert;

/** Precise NERP campaign suppression rules; match by normalized email or exact normalized name. */
export const nerpCampaignSuppressions = mysqlTable(
  ...
  table => ({
    preciseMatchUnique: uniqueIndex(
      "nerp_campaign_suppressions_precise_match_uq"
    ).on(table.institutionalAccountId, table.matchType, table.matchValue),
    institutionActiveIndex: index(
      "nerp_campaign_suppressions_institution_active_idx"
    ).on(table.institutionalAccountId, table.isActive),
  })
);
export type NerpCampaignSuppression =
...
export const nerpCampaignSuppressionAuditEvents = mysqlTable(
  ...
  table => ({
    suppressionCreatedIndex: index(
      "nerp_campaign_suppression_audit_created_idx"
    ).on(table.suppressionId, table.createdAt),
  })
);
export type NerpCampaignSuppressionAuditEvent =
  typeof nerpCampaignSuppressionAuditEvents.$inferSelect;
export type InsertNerpCampaignSuppressionAuditEvent =
  typeof nerpCampaignSuppressionAuditEvents.$inferInsert;

/** Append-only audit events for NERP payments and external completion review. */
export const nerpOfferAuditEvents = mysqlTable(
  "nerp_offer_audit_events",
  {
    id: int("id").autoincrement().primaryKey(),
    nerpOfferEnrollmentId: int("nerp_offer_enrollment_id").notNull(),
    action: varchar("action", { length: 96 }).notNull(),
  ...
  table => ({
    offerCreatedIndex: index("nerp_offer_audit_events_offer_created_idx").on(
      table.nerpOfferEnrollmentId,
      table.createdAt
    ),
  })
...
export type InsertNerpOfferAuditEvent =
  typeof nerpOfferAuditEvents.$inferInsert;
 ...
 */
export const resusGpsClinicalEvents = mysqlTable(
  "resus_gps_clinical_events",
  {
  ...
  table => ({
    sessionTimeIndex: index("resus_gps_clinical_events_session_time_idx").on(
      table.sessionId,
      table.eventTimestamp
    ),
    activationTimeIndex: index(
      "resus_gps_clinical_events_activation_time_idx"
    ).on(table.activationEventId, table.eventTimestamp),
    userTimeIndex: index("resus_gps_clinical_events_user_time_idx").on(
      table.userId,
      table.eventTimestamp
    ),
  })
