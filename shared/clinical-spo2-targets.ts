...
export const SPO2_TARGET_RESUS_DETAIL = `Use the age-, condition-, and local-protocol-specific SpO₂ target; for paediatric severe illness, treat hypoxia and aim ≥${SPO2_TARGET_MIN_PERCENT}% with titration toward ${SPO2_TARGET_MIN_PERCENT}–${SPO2_TARGET_OPTIMAL_PERCENT}% when feasible. Avoid routine hyperoxia.`;
