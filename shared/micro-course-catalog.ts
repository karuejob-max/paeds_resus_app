/**
 * Single source of truth for fellowship ADF micro-course catalog rows (client + server).
 * DB seeding and pricing live in server/lib/micro-course-catalog.ts.
 */

import { formatMicroCourseCatalogTitle } from "./micro-course-display";
...
export const MICRO_COURSE_CATALOG: MicroCourseCatalogRow[] = [
  ...
  { courseId: "septic-shock-i", title: formatMicroCourseCatalogTitle("Septic Shock", "foundational"), description: "Recognize sepsis and shock, select the age-, perfusion-, and setting-specific fluid/vasoactive pathway, and reassess after every intervention (FEAST-aware).", tier: "foundational", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 5, isPublished: true },
  ...
  { courseId: "hypovolemic-shock-i", title: formatMicroCourseCatalogTitle("Hypovolemic Shock", "foundational"), description: "Recognize hypovolaemic shock from haemorrhage or dehydration, distinguish shock phenotype, and use controlled age-, perfusion-, and setting-specific fluid/blood resuscitation with reassessment.", tier: "foundational", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 7, isPublished: true },
  ...
  { courseId: "status-epilepticus-i", title: formatMicroCourseCatalogTitle("Status Epilepticus", "foundational"), description: "Recognize status epilepticus; use the age-, route-, and formulary-specific first-line protocol. Neonatal seizures require a dedicated neonatal pathway and must not be treated as routine paediatric status.", tier: "foundational", level: "foundational", emergencyType: "seizure", duration: 45, prerequisiteId: null, order: 11, isPublished: true },
  ...
  { courseId: "anaphylaxis-i", title: formatMicroCourseCatalogTitle("Anaphylaxis", "foundational"), description: "Recognize anaphylaxis, give age-/weight-/concentration-appropriate IM adrenaline promptly, manage airway and shock, and plan risk-based observation.", tier: "foundational", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 15, isPublished: true },
  { courseId: "anaphylaxis-ii", title: formatMicroCourseCatalogTitle("Anaphylaxis", "advanced"), description: "Manage refractory anaphylaxis with expert-led adrenaline infusion/vasoactive support, airway escalation, and continuous reassessment; routine IV bolus adrenaline is not taught.", tier: "advanced", level: "advanced", emergencyType: "shock", duration: 60, prerequisiteId: "anaphylaxis-i", order: 16, isPublished: true },
  { courseId: "meningitis-i", title: formatMicroCourseCatalogTitle("Meningitis", "foundational"), description: "Recognize meningitis, assess whether lumbar puncture is safe, initiate age-/local-protocol-specific antimicrobials without unsafe delay, and manage the airway.", tier: "foundational", level: "foundational", emergencyType: "infectious", duration: 45, prerequisiteId: null, order: 17, isPublished: true },
  ...
  { courseId: "burns-i", title: formatMicroCourseCatalogTitle("Burns", "foundational"), description: "Assess burn size with an age-appropriate method, protect the airway, and select a burn-centre/age-specific fluid protocol; do not apply a universal Parkland formula.", tier: "foundational", level: "foundational", emergencyType: "burns", duration: 45, prerequisiteId: null, order: 21, isPublished: true },
  ...
  { courseId: "trauma-i", title: formatMicroCourseCatalogTitle("Trauma", "foundational"), description: "Perform an age-appropriate primary survey, control haemorrhage, protect the airway, select the local trauma/transfusion protocol, and escalate early when capability is exceeded.", tier: "foundational", level: "foundational", emergencyType: "trauma", duration: 45, prerequisiteId: null, order: 23, isPublished: true },
  ...
  { courseId: "anaemia-i", title: formatMicroCourseCatalogTitle("Anaemia", "foundational"), description: "Recognize severe anaemia, select an indication- and age-specific transfusion protocol, monitor for reactions/overload, and address the underlying cause.", tier: "foundational", level: "foundational", emergencyType: "metabolic", duration: 45, prerequisiteId: null, order: 27, isPublished: true },
