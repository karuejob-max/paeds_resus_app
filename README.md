...
**IERS onboarding and policy:** The public orientation is available at [`/iers/orientation`](https://www.paedsresus.com/iers/orientation) and from both signed-in platform dashboards. [`docs/institutional/IERS_DOCUMENTATION_INDEX.md`](docs/institutional/IERS_DOCUMENTATION_INDEX.md) routes clients, providers, administrators, reviewers, support teams, and agents to the correct detailed document; [`docs/institutional/IERS_CLIENT_ONBOARDING_AND_OPERATING_MANUAL_V1.md`](docs/institutional/IERS_CLIENT_ONBOARDING_AND_OPERATING_MANUAL_V1.md) is the external-facing operating manual.
