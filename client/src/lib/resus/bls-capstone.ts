...
export const BLS_CAPSTONE_SCENARIOS: Record<BLSPhase, BLSScenario> = {
  ...
  choking_adult: {
    ...
    correctOrder: ["ask-are-you-choking", "give-back-blows", "perform-abdominal-thrusts", "repeat-5-and-5", "start-cpr-if-unconscious"],
    shuffledOrder: ["perform-abdominal-thrusts", "ask-are-you-choking", "start-cpr-if-unconscious", "repeat-5-and-5", "give-back-blows"],
    interventions: {
      "ask-are-you-choking": { id: "ask-are-you-choking", description: "Ask 'Are you choking?'", priority: 1, critical: true },
      "give-back-blows": { id: "give-back-blows", description: "Give 5 firm back blows between the shoulder blades", priority: 2, critical: true },
      "perform-abdominal-thrusts": { id: "perform-abdominal-thrusts", description: "Give 5 abdominal thrusts (Heimlich maneuver)", priority: 3, critical: true },
      "repeat-5-and-5": { id: "repeat-5-and-5", description: "Repeat 5 back blows and 5 thrusts until object is expelled", priority: 4, critical: true },
    ...
    feedback: {
      ...
      "give-back-blows": "5 back blows delivered.",
      "perform-abdominal-thrusts": "5 thrusts delivered forcefully.",
      "repeat-5-and-5": "Object is expelled! Patient is breathing and coughing.",
