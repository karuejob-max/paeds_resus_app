  ...
  return {
    ...
    actions: [
      ...
      },
      {
        ...
        sequence: 3,
        title: 'Give Controlled Volume Support Under Protocol',
        description: `Use an age-, injury-/cause-, perfusion-, and setting-specific crystalloid or blood aliquot with reassessment after each. Do not use a universal volume or rate.`,
        rationale: 'Volume support may restore circulating volume, but excessive fluid can worsen pulmonary oedema or cerebral injury; treatment must follow the selected protocol.',
        expectedOutcome: 'Improved perfusion without signs of overload; escalate if inadequate response',
        urgency: 'critical',
        phase: 'circulation',
        timeframe: '15 minutes',
        dosing: {
          weight,
          calculation: 'Use the selected age-/cause-/perfusion-specific protocol; reassess after each aliquot',
          dose: 'Protocol-specific aliquot; no universal dose is issued here',
          route: 'IV or IO with monitoring',
        },
      ...
      },
      {
        ...
        description: 'If haemorrhage is significant, activate the local age-, injury-, compatibility-, and blood-product protocol. Do not assume O-negative availability or a universal component ratio.',
