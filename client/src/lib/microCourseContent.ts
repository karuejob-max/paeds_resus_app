...
<ul>
  ...
  <li>Response to treatment guides escalation or discharge planning</li>
    ...
    {
      id: "pals-2025-mod-10",
      title: "Module 10: PALS Summative Exam",
      duration: 60,
      learningObjectives: [
        "Demonstrate comprehensive understanding of all PALS 2025 guidelines and clinical applications.",
        "Achieve a passing score of ≥80% on the summative assessment.",
      ],
      content: `<h2>PALS 2025 Comprehensive Summative Assessment</h2>
<p>This exam is designed to evaluate your comprehensive understanding of the PALS 2025 guidelines and clinical applications across all modules. A score of 80% or higher is required to pass.</p>
<div class="clinical-note">
  <strong>Important:</strong> You will have up to 2 retries after a 24-hour waiting period between attempts to allow for review and remediation.
</div>`,
      keyPoints: [
        "Comprehensive assessment of all PALS modules.",
        "Score ≥80% required to pass.",
        "Up to 2 retries with a 24-hour waiting period.",
      ],
      references: [
        "AHA PALS Provider Manual 2025 - Comprehensive Review.",
      ],
      quiz: [
        {
          question: "A 6-month-old infant presents with grunting, nasal flaring, and a respiratory rate of 60 breaths/min. Which component of the Pediatric Assessment Triangle (PAT) is primarily affected?",
          options: ["Appearance", "Work of Breathing", "Circulation to Skin", "Disability"],
          correctAnswer: "Work of Breathing",
          explanation: "Grunting, nasal flaring, and tachypnea are all signs of increased work of breathing.",
        },
        {
          question: "Which of the following is the most reliable indicator of effective oxygenation in a pediatric patient?",
          options: ["Capillary refill time", "Pulse oximetry reading", "Heart rate", "Blood pressure"],
          correctAnswer: "Pulse oximetry reading",
          explanation: "Pulse oximetry directly measures oxygen saturation in the blood, making it the most reliable indicator of effective oxygenation.",
        },
        {
          question: "For a single rescuer performing CPR on a child, what is the correct compression-to-ventilation ratio?",
          options: ["15:2", "30:2", "5:1", "20:2"],
          correctAnswer: "30:2",
          explanation: "For a single rescuer, the recommended compression-to-ventilation ratio for both infants and children is 30:2.",
        },
        {
          question: "What is the recommended depth for chest compressions in an infant?",
          options: ["Approximately 1 inch (2.5 cm)", "Approximately 1.5 inches (4 cm)", "Approximately 2 inches (5 cm)", "Approximately 2.4 inches (6 cm)"],
          correctAnswer: "Approximately 1.5 inches (4 cm)",
          explanation: "The recommended depth for chest compressions in an infant is at least one-third of the anterior-posterior diameter of the chest, which is approximately 1.5 inches (4 cm).",
        },
        {
          question: "When should an AED be used on a child (1 year to puberty) in cardiac arrest?",
          options: ["Only after 5 cycles of CPR", "As soon as it is available", "Only if the rhythm is confirmed as asystole", "Never, only manual defibrillation is recommended"],
          correctAnswer: "As soon as it is available",
          explanation: "Early defibrillation is crucial for shockable rhythms. An AED should be used as soon as it is available.",
        },
        {
          question: "Which of the following is the most appropriate initial airway maneuver for an unresponsive child without suspected cervical spine injury?",
          options: ["Jaw thrust without head tilt", "Head tilt-chin lift", "Cricoid pressure", "Nasopharyngeal airway insertion"],
          correctAnswer: "Head tilt-chin lift",
          explanation: "The head tilt-chin lift maneuver is the preferred method to open the airway in an unresponsive child without suspected cervical spine injury.",
        },
        {
          question: "What is the target oxygen saturation range for most critically ill pediatric patients?",
          options: ["88-92%", "90-95%", "94-99%", "100%"],
          correctAnswer: "94-99%",
          explanation: "The 2025 guidelines recommend titrating oxygen to maintain SpO2 between 94-99% once stable, avoiding hyperoxia.",
        },
        {
          question: "A child with severe asthma is experiencing respiratory distress. Which medication is a first-line bronchodilator?",
          options: ["Dexamethasone", "Albuterol (Salbutamol)", "Epinephrine", "Magnesium Sulfate"],
          correctAnswer: "Albuterol (Salbutamol)",
          explanation: "Albuterol (Salbutamol) is a short-acting beta-agonist and the first-line bronchodilator for acute asthma exacerbations.",
        },
        {
          question: "What is a key sign differentiating respiratory distress from respiratory failure in a pediatric patient?",
          options: ["Tachypnea", "Nasal flaring", "Altered mental status", "Retractions"],
          correctAnswer: "Altered mental status",
          explanation: "Altered mental status is a critical sign indicating progression from respiratory distress to respiratory failure, reflecting inadequate cerebral oxygenation.",
        },
        {
          question: "In a child with septic shock, what is the updated diastolic blood pressure (DBP) target for infants (0-12 months)?",
          options: ["≥20 mmHg", "≥25 mmHg", "≥30 mmHg", "≥35 mmHg"],
          correctAnswer: "≥25 mmHg",
          explanation: "The 2025 guidelines specify a DBP target of ≥25 mmHg for infants (0-12 months) in septic shock.",
        },
        {
          question: "What is the initial fluid bolus recommendation for a child in hypovolemic shock?",
          options: ["5 mL/kg over 10-20 minutes", "10 mL/kg over 5-10 minutes", "20 mL/kg over 5-20 minutes", "30 mL/kg over 30 minutes"],
          correctAnswer: "20 mL/kg over 5-20 minutes",
          explanation: "The initial fluid bolus for hypovolemic shock is 20 mL/kg of isotonic crystalloid over 5-20 minutes.",
        },
        {
          question: "Which vasoactive medication is recommended early in septic shock if fluid resuscitation is insufficient?",
          options: ["Dopamine", "Epinephrine", "Norepinephrine", "Vasopressin"],
          correctAnswer: "Norepinephrine",
          explanation: "Norepinephrine is recommended as an early vasoactive in septic shock if fluid resuscitation is insufficient, especially in fluid-refractory shock.",
        },
        {
          question: "For a non-shockable rhythm (asystole/PEA) in pediatric cardiac arrest, when should the first dose of Epinephrine be administered?",
          options: ["After 2 minutes of CPR", "As soon as IV/IO access is established", "After the second rhythm check", "Only if bradycardia persists"],
          correctAnswer: "As soon as IV/IO access is established",
          explanation: "For non-shockable rhythms, Epinephrine should be given as soon as IV/IO access is established to improve coronary perfusion.",
        },
        {
          question: "What is the recommended energy dose for the first defibrillation in pediatric VF/pVT?",
          options: ["1 J/kg", "2 J/kg", "4 J/kg", "10 J/kg"],
          correctAnswer: "2 J/kg",
          explanation: "The recommended initial energy dose for defibrillation in pediatric VF/pVT is 2 J/kg.",
        },
        {
          question: "If VF/pVT persists after the third shock, what is the recommended dose of Amiodarone?",
          options: ["2.5 mg/kg IV/IO", "5 mg/kg IV/IO", "10 mg/kg IV/IO", "15 mg/kg IV/IO"],
          correctAnswer: "5 mg/kg IV/IO",
          explanation: "Amiodarone 5 mg/kg IV/IO is recommended for refractory VF/pVT after the third shock.",
        },
        {
          question: "How many total doses of Amiodarone (initial + repeat) can be given for refractory VF/pVT according to 2025 guidelines?",
          options: ["1", "2", "3", "4"],
          correctAnswer: "3",
          explanation: "According to 2025 guidelines, up to 3 total doses of Amiodarone (initial + 2 repeat doses) can be given for refractory VF/pVT.",
        },
        {
          question: "What is the initial medication for symptomatic bradycardia in a child with adequate perfusion?",
          options: ["Atropine", "Epinephrine", "Adenosine", "Amiodarone"],
          correctAnswer: "Atropine",
          explanation: "Atropine is the initial medication for symptomatic bradycardia with adequate perfusion, especially if due to increased vagal tone or primary AV block.",
        },
        {
          question: "For refractory supraventricular tachycardia (SVT) in a child, what is a newly recommended medication in the 2025 guidelines?",
          options: ["Procainamide", "Sotalol IV", "Digoxin", "Verapamil"],
          correctAnswer: "Sotalol IV",
          explanation: "IV Sotalol is a newly recommended medication for refractory SVT in the 2025 guidelines.",
        },
        {
          question: "What is the recommended temperature management strategy for a child post-cardiac arrest?",
          options: ["Aggressive cooling to 32-34°C", "Targeted temperature management to prevent fever (>37.5°C)", "Passive rewarming to normothermia", "Maintain hyperthermia to improve neurological outcome"],
          correctAnswer: "Targeted temperature management to prevent fever (>37.5°C)",
          explanation: "Targeted temperature management to prevent fever (>37.5°C) is recommended post-cardiac arrest to improve neurological outcomes.",
        },
        {
          question: "Which of the following is a key component of post-cardiac arrest care aimed at improving neurological outcomes?",
          options: ["Avoiding sedation", "Maintaining strict hyperglycemia", "Optimizing ventilation and oxygenation", "Early mobilization"],
          correctAnswer: "Optimizing ventilation and oxygenation",
          explanation: "Optimizing ventilation and oxygenation, along with maintaining normal glucose and blood pressure, are crucial for improving neurological outcomes post-cardiac arrest.",
        },
        {
          question: "What is the primary responsibility of the PALS Team Leader during a resuscitation?",
          options: ["Performing chest compressions", "Administering medications", "Assigning roles and making treatment decisions", "Documenting all events"],
          correctAnswer: "Assigning roles and making treatment decisions",
          explanation: "The Team Leader is responsible for overall coordination, assigning roles, and making critical treatment decisions.",
        },
        {
          question: "Which communication technique is essential for ensuring messages are understood and tasks are completed?",
          options: ["Open-ended questions", "Closed-loop communication", "Briefing", "Debriefing"],
          correctAnswer: "Closed-loop communication",
          explanation: "Closed-loop communication ensures that the sender's message is received, understood, and acted upon, with confirmation back to the sender.",
        },
        {
          question: "What is the primary role of the CPR Coach in a PALS resuscitation team?",
          options: ["To manage the airway", "To administer medications", "To ensure high-quality chest compressions and coordinate switches", "To record events and times"],
          correctAnswer: "To ensure high-quality chest compressions and coordinate switches",
          explanation: "The CPR Coach focuses on optimizing chest compression quality (rate, depth, recoil) and coordinating rescuer switches to prevent fatigue.",
        },
        {
          question: "When should a debriefing ideally occur after a resuscitation event?",
          options: ["Only if the patient had a poor outcome", "As soon as possible after the event", "During the next team meeting", "Only if requested by the team leader"],
          correctAnswer: "As soon as possible after the event",
          explanation: "Debriefing should occur as soon as possible after the event to maximize learning and retention of critical feedback.",
        },
        {
          question: "Which of the following best describes the Team Leader's involvement in hands-on tasks during a PALS resuscitation?",
          options: ["Always performs chest compressions", "Actively participates in all tasks", "Should avoid hands-on tasks unless absolutely necessary", "Primarily focuses on medication administration"],
          correctAnswer: "Should avoid hands-on tasks unless absolutely necessary",
          explanation: "The Team Leader's primary role is to oversee and direct, not to be involved in hands-on tasks, to maintain situational awareness.",
        },
      ],
    },
    {
...
},
{
  ...
  duration: 60,
  learningObjectives: [
    "Demonstrate comprehensive understanding of PALS 2025 guidelines",
    "Apply critical thinking to pediatric resuscitation scenarios",
    "Achieve a passing score of 80% or higher on the summative assessment",
  ],
  content: `<h2>PALS 2025 Comprehensive Summative Assessment</h2>\r\n<p>This exam is designed to evaluate your comprehensive understanding of the PALS 2025 guidelines and clinical applications across all modules. A score of 80% or higher is required to pass.</p>\r\n<div class="clinical-note">\r\n  <strong>Important:</strong> You will have up to 2 retries after a 24-hour waiting period between attempts to allow for review and remediation.\r\n</div>`,
  keyPoints: [
    "Review all previous modules before attempting the summative exam.",
    "Focus on systematic assessment, early recognition, and appropriate interventions.",
    "Understand the rationale behind each answer to maximize learning from retries.",
  ],
  references: [
    "AHA PALS Provider Manual 2025 - Full Guidelines.",
    "All module-specific references from Modules 1-9.",
  ],
  quiz: [
    {
      question: "A 6-month-old infant presents with grunting, nasal flaring, and a respiratory rate of 60 breaths/min. Which component of the Pediatric Assessment Triangle (PAT) is primarily affected?",
...
<div class="clinical-note">
  <strong>Important:</strong> You will have up to 2 retries after a 24-hour waiting period between attempts to allow for review and remediation.
    ...
    },
    {
      ...
      learningObjectives: [
        "Demonstrate comprehensive understanding of all PALS 2025 guidelines and clinical applications.",
        "Apply systematic assessment and management strategies to pediatric emergencies.",
        "Identify key interventions for respiratory, circulatory, and cardiac arrest scenarios.",
        "Recognize the importance of effective team dynamics and communication in resuscitation.",
      ],
      content: `<h2>PALS 2025 Comprehensive Summative Assessment</h2>\r\n<p>This exam is designed to evaluate your comprehensive understanding of the PALS 2025 guidelines and clinical applications across all modules. A score of 80% or higher is required to pass.</p>\r\n<div class="clinical-note">\r\n  <strong>Important:</strong> You will have up to 2 retries after a 24-hour waiting period between attempts to allow for review and remediation.\r\n</div>`,
      keyPoints: [
        "Systematic approach to assessment and management.",
        "High-quality CPR and early defibrillation.",
        "Appropriate medication administration and dosing.",
        "Effective team dynamics and closed-loop communication.",
        "Post-cardiac arrest care and recovery principles.",
      ],
      references: [
        "AHA PALS Provider Manual 2025.",
        "AHA Guidelines for Cardiopulmonary Resuscitation and Emergency Cardiovascular Care 2025.",
      ],
      quiz: [
        {
          question: "A 6-month-old infant presents with grunting, nasal flaring, and a respiratory rate of 60 breaths/min. Which component of the Pediatric Assessment Triangle (PAT) is primarily affected?",
    ...
    },
    {
      ...
      duration: 30,
      learningObjectives: [
        "Demonstrate comprehensive knowledge of all PALS 2025 guidelines and concepts.",
        "Achieve a passing score of ≥80% on the summative assessment.",
        "Apply critical thinking to complex pediatric resuscitation scenarios.",
      ],
      content: `<h2>PALS Summative Exam</h2>
<p>This comprehensive examination assesses your understanding of all modules covered in the PALS 2025 course. It is designed to evaluate your ability to apply critical knowledge and decision-making skills in pediatric resuscitation scenarios.</p>
<h3>Exam Details:</h3>
<ul>
  <li><strong>Number of Questions:</strong> 25</li>
  <li><strong>Passing Score:</strong> ≥80%</li>
  <li><strong>Retries:</strong> Up to 2 retries allowed, with a 24-hour waiting period between attempts to encourage review.</li>
  <li><strong>Topics Covered:</strong> All 9 PALS modules, including Pediatric Assessment, BLS, Airway Management, Respiratory Emergencies, Circulatory Emergencies, Cardiac Arrest Algorithms, Arrhythmias, Post-Arrest Care, and Team Dynamics.</li>
</ul>
<div class="clinical-note">
  <strong>Success Tip:</strong> Review all module content, key points, and formative quizzes before attempting the summative exam. Focus on understanding the 'why' behind each guideline.
</div>`,
      keyPoints: [
        "Comprehensive assessment of PALS 2025 knowledge.",
        "Requires ≥80% to pass.",
        "Covers all 9 modules.",
        "Designed to test application of knowledge.",
      ],
      references: [
        "AHA PALS Provider Manual 2025 - Comprehensive Review.",
        "PALS 2025 Guidelines Update - Summary of Key Changes.",
      ],
      quiz: [], // Summative quiz questions are dynamically loaded from the database
    },
  ],
};
