...
const HND_SPECIALTIES = [
  ...
  { value: "Nurse Anaesthesia (KRNA)", label: "Nurse Anaesthesia (KRNA)" },
  ...
  { value: "Midwifery (Reproductive Health)", label: "Midwifery (Reproductive Health)" },
...
export default function CadreProgressiveSelector({
  ...
  const showFreeTextDetails =
    ...
    ["Other Medical Student", "Other Clinical Officer Student", "Other Nursing Student", "Other BSN Student", "Other Diploma Student", "Other Certificate Student", "Other Diploma Nursing Student", "Other Certificate Nursing Student", "Other RN", "Other Diploma RN", "Other Certificate RN"].includes(localRnSub) ||
    ["Other Medical Student", "Other Clinical Officer Student", "Other Nursing Student"].includes(localRnLevel) ||
  ...
  return (
    <div className="space-y-4">
      ...
      {/* T3: Level (RN / RN Student Level Selection / Specialty level) */}
      {(localRole === "RN" ||
