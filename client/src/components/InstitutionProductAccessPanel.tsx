  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <p className="border-t pt-4 text-xs text-muted-foreground">Subscription changes are handled through the Paeds Resus operations team. Institution administrators can request renewal above; platform-level status overrides are not part of institution self-service.</p>
      </CardContent>
    </Card>
  );
}
