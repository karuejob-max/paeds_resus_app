  ...
  return (
    <div className="space-y-6">
      <Card className="border-amber-200 bg-amber-50/40">
        <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-amber-950 text-base"><ShieldCheck className="h-5 w-5" /> Pilot preflight</CardTitle><CardDescription className="text-amber-900/80">This checklist prevents an unlinked, unreviewed, or mislabelled drill from being presented as IERS readiness.</CardDescription></CardHeader>
