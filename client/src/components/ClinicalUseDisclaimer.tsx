  ...
  return (
    <Alert className="mx-4 mt-2 border-[#1a4d4d]/30 bg-[#f0f9f9]/80 dark:bg-[#0f2525]/80">
      ...
      <AlertDescription className="text-sm text-[#1a4d4d] dark:text-teal-100 flex flex-col gap-3">
        <div>
          <strong>ResusGPS intended use:</strong> structured emergency <strong>reference support</strong> for trained providers.
          The selected pathway is age and context dependent: NRP only for an explicitly selected delivery-room newborn context,
          PALS for hospital or prehospital infants and children, and ACLS for adults. Verify the displayed pathway and doses
          against your approved local protocol and the treating clinician’s judgement. Not medical advice or an emergency service —
          call <strong>{formatKenyaEmergencyShort()}</strong>; EAC: {formatEacEmergencyInline()}. Your facility protocol and senior review always prevail.
        </div>
