...
describe("EnrollmentModal Integration Tests", () => {
  ...
  let mockSubmitManualMpesaReference: { mutateAsync: ReturnType<typeof vi.fn> };
  ...
  beforeEach(() => {
    ...
    mockSubmitManualMpesaReference = {
      mutateAsync: vi.fn(),
    };

    vi.mocked(trpc.mpesa.getClientPaymentCapabilities.useQuery).mockReturnValue({
      data: { paybillNumber: "4034223", accountNumber: "PAEDSRESUS" },
    } as ReturnType<typeof trpc.mpesa.getClientPaymentCapabilities.useQuery>);
    ...
    vi.mocked(trpc.enrollment.submitManualMpesaReference.useMutation).mockReturnValue(
      mockSubmitManualMpesaReference as unknown as ReturnType<
        typeof trpc.enrollment.submitManualMpesaReference.useMutation
      >
    );
