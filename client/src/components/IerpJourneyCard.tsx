...
export function IerpJourneyCard({
  title,
  subtitle,
  percentComplete,
  phases,
    ...
    <Card className="overflow-hidden border-slate-200 bg-white shadow-[0_18px_50px_-30px_rgba(15,23,42,0.45)]">
      <CardHeader className={compact ? "pb-3" : "pb-4"}>
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-teal-700">Your next IERP step</p>
