...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-brand-teal text-muted-foreground py-8 px-4 border-t-2 border-brand-orange"
      role="contentinfo"
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 mb-2">
              Making emergency care readiness visible through practical
              training, institutional systems, and honest learning.
            </p>
            <p className="text-xs text-white/70">
              <strong className="text-white/85">Platform:</strong> Paeds Resus
              (brand). <strong className="text-white/85">Products:</strong> IERS
              includes ResusGPS for bedside guidance and Care Signal for
              institutional improvement; Safe-Truth supports families and
              caregivers.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-bold mb-3 text-brand-orange">
              Quick Links
            </h4>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="mailto:paedsresus254@gmail.com"
                  className="text-white/70 hover:text-brand-orange transition flex items-center gap-2"
                >
