        ...
        <Dialog open={open} onOpenChange={() => {}}>
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto" onPointerDownOutside={(e) => e.preventDefault()}>
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <p>
                Read the{" "}
                <a href="/privacy#care-signal" target="_blank" rel="noopener noreferrer" className="text-primary underline">
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 rounded-md border p-3">
                  ...
                  />
                  <Label htmlFor="care-signal-qi" className="leading-snug cursor-pointer">
                ...
                <div className="flex items-start gap-2 rounded-md border p-3">
                  ...
                  />
                  <Label htmlFor="care-signal-no-phi" className="leading-snug cursor-pointer">
                ...
                <div className="flex items-start gap-2 rounded-md border p-3">
                  ...
                  />
                  <Label htmlFor="care-signal-facility" className="leading-snug cursor-pointer">
            ...
            <DialogFooter className="flex-col sm:flex-row gap-2">
              <Button variant="outline" asChild>
                <a href="/care-signal/appeal">Appeals process</a>
              </Button>
