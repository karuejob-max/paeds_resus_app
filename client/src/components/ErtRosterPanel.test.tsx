...
const {
  ...
  departmentNurseCandidatesQuery,
  shiftTemplatesQuery,
  monthlyRotaQuery,
  ercoAssignmentsQuery,
  shiftRosterQuery,
  canonicalShiftTeamQuery,
  weeklyRotationQuery,
  adminStatusQuery,
  useMutation,
  invalidate,
  ...
  departmentNurseCandidatesQuery: vi.fn(() => ({ data: [], isLoading: false })),
  ...
  canonicalShiftTeamQuery: vi.fn(() => ({ data: null, isLoading: false })),
  weeklyRotationQuery: vi.fn(() => ({ data: undefined })),
  adminStatusQuery: vi.fn(() => ({ data: { isInstitutionAdmin: false } })),
...
vi.mock("@/lib/trpc", () => ({
  trpc: {
    ...
    institution: {
      ...
      getDepartmentNurseCandidates: { useQuery: departmentNurseCandidatesQuery },
      ...
      getCanonicalShiftTeam: { useQuery: canonicalShiftTeamQuery },
      getWeeklyErtlRotation: { useQuery: weeklyRotationQuery },
      getMyInstitutionAdminStatus: { useQuery: adminStatusQuery },
      createFacilityPole: { useMutation },
      reorderFacilityPoles: { useMutation },
      setWeeklyErtlRotation: { useMutation },
      overrideWeeklyErtlLeadership: { useMutation },
      cancelFutureShiftUtlAssignment: { useMutation },
