  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Subsidised ACLS/BLS Cohort Programme (KES 15,000 Kenya pricing) — two tracks, different rules. All payments are non-refundable regardless of completion, withdrawal, or inability to progress. For IERP (interns), August–November starters may access Phase 1 cognitive coursework and Phase 2 online simulations before payment, but full payment is required from 1 December EAT onward and always before Phase 3. December–July starters must pay the full KES 15,000 before cognitive access. IERP is not a Lipa Mdogo Mdogo: the remaining balance must be paid in one payment. The Nurse Cohort Program requires a licence number on file; KES 2,500/month is required from enrolment with no deferral, and falling behind that pace loses booking access until caught up. Phase 3 requires full payment for both tracks.",
