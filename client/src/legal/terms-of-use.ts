  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Subsidised ACLS/BLS Cohort Programme (KES 15,000 Kenya pricing) — two tracks, different rules. All payments, including partial and instalment payments, are non-refundable regardless of completion, withdrawal, or inability to progress, for both tracks. Phase 3 (hands-on Megacode, final exam, certification) requires full payment first, for both tracks. IERP (interns): no payment required to start; if your account shows zero payment four months after joining, you lose the ability to book further online simulation sessions until a payment is made. Nurse Cohort Program: requires a licence number on file; KES 2,500/month required from enrolment with no deferral — falling behind that pace loses booking access the same way until you catch up.",
