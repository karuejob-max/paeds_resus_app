      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-brand-surface/50">
        ...
        <header className="max-w-4xl mx-auto px-4 py-12">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            With roughly two nurses per department per shift, a code still leaves the ward needing continuous coverage.

            Paeds Resus helps hospitals build a <strong className="font-semibold text-foreground">hospital-wide Emergency

            Response System (ERS)</strong> — nurse-led ERT, 24/7, with hospital-wide coordination across units. ResusGPS

            bedside guidance, Care Signal QI, AHA-aligned training from Paeds Resus Limited, and equipment readiness

            audits. Working ERS plus training — not generic bulk certification or seat bundles.
        ...
        <div className="max-w-4xl mx-auto px-4 pb-12 space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            fixes. We publish only supportable process metrics — no mortality claims until governed evaluation
