...
| 4 | FB-AN-2 | **Verify Admin + `verify:analytics`** | Admin UI, `pnpm run verify:analytics`, docs note | FB-AN-1 | — | Not started | Manus | | Document expected eventType in Notes |
...
| 7 | FB-OPS-1 | **Staging / deploy checklist note** | `docs/STAGING_DEPLOYMENT.md` or RENDER doc | — | All | Not started | Manus | | DB migration order: existing + new Care Signal migration |
