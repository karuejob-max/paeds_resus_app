...
|------|-----|------|----------|
| 2026-04-01 | Cursor | **Learner dashboard instructor CTAs:** `Enroll` anchors `#course-instructor`; provider hub “Courses & certification” links **Continue: Instructor Course** (when enrolled), **Enroll: Instructor Course**, **Instructor portal**; shows instructor number + pending approval when certified. | (this commit) |
