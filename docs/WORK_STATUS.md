...
|------|-----|------|----------|
| 2026-04-02 | Cursor | **Clinical protocols docs + ResusGPS alignment:** `docs/clinical-protocols/` (README, RESUSGPS_REGISTRY, `_TEMPLATE`, `paediatric-septic-shock.md`); `docs/E2E_PAEDIATRIC_SEPTIC_SHOCK_COURSE.md`; README documentation map; code pointers in `pathways/shock.ts` and `abcdeEngine.ts`. | `2cee120` |
