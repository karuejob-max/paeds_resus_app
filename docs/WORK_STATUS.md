...
|------|-----|------|----------|
| 2026-04-01 | Cursor | **Enroll UX:** Copy + anchor `#course-pals` on `/enroll` so “The systematic approach to a seriously ill child” (KES 100) is discoverable; E2E doc “where it appears”. | (this commit) |
