...
|------|-----|------|----------|
| 2026-04-01 | Cursor | **Brand theme & readability:** CSS tokens `#1B3D3D` / `#F37021`, light default + `ThemeToggle`; `index.css` contrast (muted-foreground, surfaces); Header/Enroll/Payment/LearnerDashboard use semantic colors; `Button` variant `cta`; logo `paeds-resus-logo-brand.png`. | `1d1761b` |
