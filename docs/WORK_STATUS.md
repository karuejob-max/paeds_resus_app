...
|------|-----|------|----------|
| 2026-04-02 | Cursor | **Production enrollments failing (missing `courseId` column):** `docs/RENDER_PREDEPLOY_LOCKED.md` §0029; clearer `enrollment.create` error when DB lacks `enrollments.courseId`; E2E septic doc notes production must run `pnpm run db:apply-0029`. | `ef0e24b` |
