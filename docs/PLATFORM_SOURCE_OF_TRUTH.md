...
The **Institutional Life Support Training Program** is a first-class learning product for individual providers and institution-paid cohorts. The base price is **KES 10,000 per provider**. It uses online modules, knowledge checks, practical assessment, and Paeds Resus competency certification. It does not issue an AHA certificate. After Paeds Resus certification, a learner may request BLS credentialing for **KES 7,500** or ACLS credentialing for **KES 10,000**, provided the request and payment are completed within **90 days** of certificate issue. No additional training is charged during that window, but the request remains subject to AHA credentialing review. After the window, a new full training enrolment applies at **KES 10,000 for BLS** or **KES 20,000 for ACLS**.
