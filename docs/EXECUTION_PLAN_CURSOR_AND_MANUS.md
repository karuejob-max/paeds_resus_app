...
| # | Task ID | Title | Spec summary | Where | Status |
|---|---------|--------|----------------|-------|--------|
| 7 | **B2** | Institutional onboarding → portal | After onboarding success, redirect to `/hospital-admin-dashboard` (legacy `/institutional-portal` redirects). Optionally add welcome/first-time state in institutional dashboard. | `client/src/pages/InstitutionalOnboarding.tsx`, `client/src/pages/HospitalAdminDashboard.tsx` | ✅ Done (by Cursor) 2026-02-25 |
