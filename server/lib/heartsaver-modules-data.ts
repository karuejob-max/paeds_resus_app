...
<table>
  ...
  <tbody>
    ...
    <tr><td>Survival rate without bystander CPR</td><td>~5â€“8%</td></tr>
    <tr><td>Survival rate with bystander CPR</td><td>~15â€“20%</td></tr>
...
<div class="warning-note">
  <strong>Agonal breathing:</strong> Agonal breathing (gasping, snoring, or irregular breathing) is a sign of cardiac arrest â€” NOT normal breathing. Do not mistake it for normal breathing and delay CPR. If in doubt, begin CPR.
</div>
...
<p>Calling emergency services immediately is a critical link in the Chain of Survival. Do not delay calling â€” call while beginning CPR if you are alone.</p>
...
<ul>
  ...
  <li>Stay on the line â€” the dispatcher will guide you through CPR</li>
</ul>
<div class="clinical-note">
...
<div class="warning-note">
      ...
      questions: [
        {
          ...
          options: JSON.stringify(["Place them in the recovery position and monitor", "Begin CPR immediately â€” gasping is a sign of cardiac arrest", "Wait to see if the gasping improves", "Check their pulse for 30 seconds before deciding"]),
          correctAnswer: "Begin CPR immediately â€” gasping is a sign of cardiac arrest",
        ...
        },
        {
          ...
          options: JSON.stringify(["Begin 2 minutes of CPR, then call emergency services", "Call emergency services first, then begin CPR", "Begin CPR and do not call â€” focus on compressions", "Wait for someone else to call"]),
          correctAnswer: "Call emergency services first, then begin CPR",
          explanation: "For a witnessed adult cardiac arrest, call emergency services first (or use speakerphone while doing CPR). The exception is for children â€” if you witness a child collapse, do 2 minutes of CPR first, then call, because paediatric arrests are usually respiratory in origin."
        },
        {
          order: 3,
          ...
          explanation: "The recovery position is for unresponsive people who are breathing normally. It keeps the airway open and prevents aspiration. Do NOT use the recovery position if the person is not breathing normally â€” begin CPR instead."
        }
      ]
    }
  },
  {
    order: 2,
    title: "Module 2: Adult CPR â€” Hands-Only and Standard",
    ...
    sections: [
      {
        order: 1,
        title: "Overview: High-Quality CPR â€” What It Means",
        content: `<h2>High-Quality CPR â€” What It Means</h2>
...
<table>
  ...
  <tbody>
    <tr><td>Compression rate</td><td>100â€“120 compressions per minute</td></tr>
...
<ol>
  ...
  <li><strong>Compressions:</strong> Push hard and fast â€” at least 5 cm deep; 100â€“120 per minute</li>
...
<div class="warning-note">
  <strong>Push hard and fast:</strong> Most bystanders do not compress deeply enough. You need to compress at least 5 cm (2 inches) â€” this requires significant force. Do not be afraid of hurting the person â€” rib fractures can occur but are acceptable in the context of cardiac arrest.
</div>`
      },
      {
        order: 3,
        title: "Standard CPR â€” Compressions with Rescue Breaths",
        content: `<h2>Standard CPR â€” Compressions with Rescue Breaths</h2>
...
<ol>
  ...
  <li>Give 1 breath over 1 second â€” watch for chest rise</li>
  <li>Allow chest to fall; give second breath</li>
  <li>Resume compressions immediately</li>
</ol>
<div class="clinical-note">
  <strong>Visible chest rise is the target:</strong> Give just enough air to produce visible chest rise. Over-ventilation (too much air, too fast) causes gastric inflation, regurgitation, and reduced venous return â€” all of which worsen outcomes.
</div>
...
<ul>
  ...
  <li>Prolonged arrest (&gt;4â€“5 minutes without CPR)</li>
</ul>`
      },
      {
        order: 4,
...
<p>CPR is physically demanding. Compression quality deteriorates significantly after 1â€“2 minutes. When multiple rescuers are present, rotate compressions every 2 minutes.</p>
...
<ul>
  ...
  <li>End-tidal COâ‚‚ &gt;10 mmHg (if capnography available)</li>
...
<div class="clinical-note">
      ...
      questions: [
        {
          ...
          options: JSON.stringify(["2â€“3 cm", "At least 5 cm (2 inches), no more than 6 cm (2.4 inches)", "7â€“8 cm", "1/3 of the chest AP diameter"]),
        ...
        },
        {
          ...
          options: JSON.stringify(["15:2", "30:2", "5:1", "Compressions only â€” no breaths"]),
          correctAnswer: "30:2",
        ...
        },
        {
          ...
          explanation: "Compression quality deteriorates significantly after 1â€“2 minutes due to fatigue. Rescuers should rotate compressions every 2 minutes (or every 5 cycles of 30:2). The switch should take less than 5 seconds to minimise interruption to compressions."
        }
      ]
    }
  },
  {
    ...
    content: "Defibrillation within 3â€“5 minutes of collapse can achieve survival rates of 50â€“70%. This module covers AED use for lay rescuers.",
    duration: 15,
    sections: [
      {
        order: 1,
...
<ul>
  ...
  <li>VF is a shockable rhythm â€” defibrillation is the only effective treatment</li>
  <li>Survival decreases by 7â€“10% for every minute without defibrillation</li>
  <li>AEDs are designed for use by untrained bystanders â€” they analyse the rhythm automatically and only shock if appropriate</li>
</ul>
<h3>AED Safety</h3>
<ul>
  <li>AEDs will NOT shock a normal rhythm â€” they only shock VF and pVT</li>
  ...
  <li>Do not place pads over an implanted pacemaker or ICD â€” place at least 2.5 cm away</li>
</ul>`
      },
      {
        order: 2,
        title: "How to Use an AED â€” Step by Step",
        content: `<h2>How to Use an AED â€” Step by Step</h2>
...
<ol>
  ...
  <li><strong>Analyse the rhythm:</strong> The AED will say "Analysing rhythm â€” do not touch the patient." Stand clear; do not touch the patient.</li>
  <li><strong>Deliver shock (if advised):</strong>
    <ul>
      <li>The AED will say "Shock advised â€” stand clear"</li>
...
<div class="warning-note">
  <strong>Minimise interruptions:</strong> The time between stopping compressions and delivering the shock should be less than 5 seconds. Resume CPR immediately after the shock â€” do not wait to check for a pulse.
</div>`
      },
      {
        order: 3,
...
<ul>
  <li>Use paediatric pads (attenuate energy to 50â€“75 J) if available</li>
  <li>If only adult pads available: use adult pads â€” do NOT delay defibrillation</li>
...
<ul>
  <li>You can still use an AED â€” do not delay defibrillation</li>
  <li>Place pads at least 2.5 cm (1 inch) away from the device</li>
  <li>The ICD may fire first â€” if it does, wait 30â€“60 seconds before using the AED</li>
</ul>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>0:00â€“2:00</td><td>Begin CPR; send someone for AED</td></tr>
      ...
      questions: [
        {
          ...
          explanation: "After delivering a shock, resume CPR immediately â€” do not wait to check for a pulse. The AED will re-analyse the rhythm after 2 minutes of CPR. Waiting to check for a pulse interrupts compressions and reduces survival."
        },
        {
          order: 2,
          questionText: "You need to use an AED on a 5-year-old child. You only have adult AED pads. What should you do?",
          options: JSON.stringify(["Do not use the AED â€” it is not safe for children", "Use adult pads â€” do not delay defibrillation", "Use only one pad on the chest", "Wait for paediatric pads to arrive"]),
          correctAnswer: "Use adult pads â€” do not delay defibrillation",
          explanation: "If paediatric pads are not available, use adult pads â€” do NOT delay defibrillation. Place pads in the anterior-posterior position (front and back) if they are too large to fit on the chest without overlapping. Defibrillation with adult pads is safer than no defibrillation."
        },
        {
          order: 3,
...
<table>
  <thead><tr><th>Feature</th><th>Adult</th><th>Child (1â€“8 years)</th><th>Infant (&lt;1 year)</th></tr></thead>
  <tbody>
...
<div class="warning-note">
  <strong>Infant airway:</strong> In infants, the head is proportionally large and the occiput is prominent. Placing an infant flat will flex the neck and obstruct the airway. Place a small shoulder roll (folded towel) under the shoulders to achieve a neutral airway position.
      ...
      {
        order: 2,
        title: "Child CPR (1â€“8 Years)",
        content: `<h2>Child CPR (1â€“8 Years)</h2>
...
<ol>
  ...
  <li><strong>If alone:</strong> Do 2 minutes of CPR first, then call emergency services (respiratory cause â€” ventilation is priority)</li>
  ...
  <li><strong>Give 2 rescue breaths:</strong> Small breaths â€” just enough to see the chest rise</li>
...
<ol>
  ...
  <li><strong>Open airway:</strong> Neutral position â€” do not hyperextend (use shoulder roll if needed)</li>
...
<div class="warning-note">
  <strong>Do NOT perform blind finger sweeps:</strong> Never perform a blind finger sweep to remove a foreign body â€” this can push the object deeper. Only remove an object if you can clearly see it.
</div>`
      }
    ],
    quiz: {
      ...
      questions: [
        {
          ...
          options: JSON.stringify(["Call emergency services immediately before starting CPR", "Do 2 minutes of CPR, then call emergency services", "Begin CPR and do not call â€” focus on ventilation", "Place the child in the recovery position"]),
          correctAnswer: "Do 2 minutes of CPR, then call emergency services",
          explanation: "For a child collapse when you are alone, do 2 minutes of CPR first, then call emergency services. Paediatric cardiac arrest is usually respiratory in origin â€” 2 minutes of CPR (with ventilation) may reverse the arrest before EMS arrives. This differs from adult cardiac arrest where you call first."
        },
        {
          order: 2,
