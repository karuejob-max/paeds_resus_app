...
export const MICRO_COURSE_CATALOG: MicroCourseCatalogRow[] = [
  ...
  { courseId: "septic-shock-i", title: "Paediatric Septic Shock I: Recognition and Fluid Resuscitation", description: "Recognize sepsis criteria, implement 20 mL/kg bolus, assess perfusion, and plan vasopressor escalation.", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 5, isPublished: false },
  ...
  { courseId: "cardiogenic-shock-i", title: "Paediatric Cardiogenic Shock I: Heart Failure Recognition", description: "Recognize acute heart failure, assess cardiac function, manage fluid overload, prepare for inotropic support.", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 9, isPublished: false },
  ...
  { courseId: "dka-i", title: "Paediatric DKA I: Recognition and Initial Fluid Resuscitation", description: "Recognize DKA severity, calculate fluid deficit, initiate isotonic fluid resuscitation, manage electrolytes.", level: "foundational", emergencyType: "metabolic", duration: 45, prerequisiteId: null, order: 13, isPublished: false },
  ...
  { courseId: "anaphylaxis-i", title: "Paediatric Anaphylaxis I: Recognition and Epinephrine", description: "Recognize anaphylaxis, calculate epinephrine dose (0.01 mg/kg IM), manage airway, assess for biphasic reaction.", level: "foundational", emergencyType: "shock", duration: 45, prerequisiteId: null, order: 15, isPublished: false },
  ...
  { courseId: "trauma-i", title: "Paediatric Trauma I: Primary Survey and Resuscitation", description: "Perform primary survey (ABCDE), calculate fluid requirements, manage airway in trauma, activate trauma protocol.", level: "foundational", emergencyType: "trauma", duration: 45, prerequisiteId: null, order: 23, isPublished: false },
