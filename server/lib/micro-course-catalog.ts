...
export const MICRO_COURSE_CATALOG: MicroCourseCatalogRow[] = [
  ...
  { courseId: "dka-ii", title: "Paediatric DKA II: Insulin Therapy and Complications", description: "Manage insulin infusion, prevent cerebral edema, monitor electrolyte shifts, manage hyperkalemia.", level: "advanced", emergencyType: "metabolic", duration: 60, prerequisiteId: "dka-i", order: 14, isPublished: true },
