...
export const MICRO_COURSE_CATALOG: MicroCourseCatalogRow[] = [
  ...
  { courseId: "asthma-i", title: "Paediatric Asthma Level 1: Recognition, 1st & 2nd Line", description: "Recognize asthma severity; salbutamol + ipratropium; dexamethasone, prednisolone, or hydrocortisone where taught.", level: "foundational", emergencyType: "respiratory", duration: 45, prerequisiteId: null, order: 1, isPublished: true },
  { courseId: "asthma-ii", title: "Paediatric Asthma Level 2: Status Asthmaticus & Advanced", description: "Status asthmaticus; continuous nebulised salbutamol; IV salbutamol where appropriate; magnesium; ICU escalation.", level: "advanced", emergencyType: "respiratory", duration: 60, prerequisiteId: "asthma-i", order: 2, isPublished: true },
  ...
  { courseId: "status-epilepticus-i", title: "Status Epilepticus Level 1: Recognition & First-Line", description: "SE recognition; midazolam/lorazepam international first-line; Kenya diazepam option; neonates — no benzos.", level: "foundational", emergencyType: "seizure", duration: 45, prerequisiteId: null, order: 11, isPublished: true },
  { courseId: "status-epilepticus-ii", title: "Status Epilepticus Level 2: Refractory & ICU", description: "Refractory SE; second-line agents; intubation readiness; continuous EEG where available.", level: "advanced", emergencyType: "seizure", duration: 60, prerequisiteId: "status-epilepticus-i", order: 12, isPublished: true },
  { courseId: "dka-i", title: "DKA Level 1: Recognition & Fluids (mmol/L)", description: "DKA in mmol/L; fluids NS vs balanced crystalloid; insulin when safe — until ketosis resolving.", level: "foundational", emergencyType: "metabolic", duration: 45, prerequisiteId: null, order: 13, isPublished: true },
  { courseId: "dka-ii", title: "DKA Level 2: Insulin, Ketones & Complications", description: "Insulin infusion; cerebral oedema vigilance; electrolytes; euglycemic DKA.", level: "advanced", emergencyType: "metabolic", duration: 60, prerequisiteId: "dka-i", order: 14, isPublished: true },
  ...
  { courseId: "burns-ii", title: "Paediatric Burns II: Wound Management and Infection Prevention", description: "Manage burn wounds, prevent infection, manage pain, prepare for skin grafting, manage compartment syndrome.", level: "advanced", emergencyType: "burns", duration: 60, prerequisiteId: "burns-i", order: 22, isPublished: true },
