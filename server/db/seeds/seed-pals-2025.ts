...
<div class="clinical-note">
  <strong>Continuous Learning:</strong> Every resuscitation is an opportunity to learn and refine skills, both individually and as a team.
    ...
    },
    {
      ...
      description: "Comprehensive assessment of all PALS 2025 guidelines and clinical applications. Score ≥80% required to pass, with up to 2 retries after a 24-hour waiting period.",
      ...
      sections: [
        {
          order: 1,
          title: "PALS 2025 Comprehensive Summative Assessment",
          content: `<h2>PALS 2025 Comprehensive Summative Assessment</h2>\r\n<p>This exam is designed to evaluate your comprehensive understanding of the PALS 2025 guidelines and clinical applications across all modules. A score of 80% or higher is required to pass.</p>\r\n<div class="clinical-note">\r\n  <strong>Important:</strong> You will have up to 2 retries after a 24-hour waiting period between attempts to allow for review and remediation.\r\n</div>`,
        },
      ],
      quiz: {
        title: "PALS 2025 Comprehensive Summative Exam",
        passingScore: 80,
        questions: [
          {
            order: 1,
            questionText: "A 6-month-old infant presents with grunting, nasal flaring, and a respiratory rate of 60 breaths/min. Which component of the Pediatric Assessment Triangle (PAT) is primarily affected?",
            options: JSON.stringify(["Appearance", "Work of Breathing", "Circulation to Skin", "Disability"]),
          ...
          {
            order: 2,
            questionText: "Which of the following is the most reliable indicator of effective oxygenation in a pediatric patient?",
            options: JSON.stringify(["Capillary refill time", "Pulse oximetry reading", "Heart rate", "Blood pressure"]),
          ...
          {
            order: 3,
            questionText: "For a single rescuer performing CPR on a child, what is the correct compression-to-ventilation ratio?",
            options: JSON.stringify(["15:2", "30:2", "5:1", "20:2"]),
            correctAnswer: "30:2",
          ...
          {
            order: 4,
            questionText: "What is the recommended depth for chest compressions in an infant?",
            options: JSON.stringify(["Approximately 1 inch (2.5 cm)", "Approximately 1.5 inches (4 cm)", "Approximately 2 inches (5 cm)", "Approximately 2.4 inches (6 cm)"]),
          ...
          {
            order: 5,
            questionText: "When should an AED be used on a child (1 year to puberty) in cardiac arrest?",
            options: JSON.stringify(["Only after 5 cycles of CPR", "As soon as it is available", "Only if the rhythm is confirmed as asystole", "Never, only manual defibrillation is recommended"]),
          ...
          {
            order: 6,
            questionText: "Which of the following is the most appropriate initial airway maneuver for an unresponsive child without suspected cervical spine injury?",
            options: JSON.stringify(["Jaw thrust without head tilt", "Head tilt-chin lift", "Cricoid pressure", "Nasopharyngeal airway insertion"]),
          ...
          {
            order: 7,
            questionText: "What is the target oxygen saturation range for most critically ill pediatric patients?",
            options: JSON.stringify(["88-92%", "90-95%", "94-99%", "100%"]),
            correctAnswer: "94-99%",
            explanation: "The 2025 guidelines recommend titrating oxygen to maintain SpO2 between 94-99% once stable, avoiding hyperoxia.",
          },
          {
            order: 8,
            questionText: "A child with severe asthma is experiencing respiratory distress. Which medication is a first-line bronchodilator?",
            options: JSON.stringify(["Dexamethasone", "Albuterol (Salbutamol)", "Epinephrine", "Magnesium Sulfate"]),
          ...
          {
            order: 9,
            questionText: "What is a key sign differentiating respiratory distress from respiratory failure in a pediatric patient?",
            options: JSON.stringify(["Tachypnea", "Nasal flaring", "Altered mental status", "Retractions"]),
          ...
          {
            order: 10,
            questionText: "In a child with septic shock, what is the updated diastolic blood pressure (DBP) target for infants (0-12 months)?",
            options: JSON.stringify(["≥20 mmHg", "≥25 mmHg", "≥30 mmHg", "≥35 mmHg"]),
          ...
          {
            order: 11,
            questionText: "What is the initial fluid bolus recommendation for a child in hypovolemic shock?",
            options: JSON.stringify(["5 mL/kg over 10-20 minutes", "10 mL/kg over 5-10 minutes", "20 mL/kg over 5-20 minutes", "30 mL/kg over 30 minutes"]),
          ...
          {
            order: 12,
            questionText: "Which vasoactive medication is recommended early in septic shock if fluid resuscitation is insufficient?",
            options: JSON.stringify(["Dopamine", "Epinephrine", "Norepinephrine", "Vasopressin"]),
          ...
          {
            order: 13,
            questionText: "For a non-shockable rhythm (asystole/PEA) in pediatric cardiac arrest, when should the first dose of Epinephrine be administered?",
            options: JSON.stringify(["After 2 minutes of CPR", "As soon as IV/IO access is established", "After the second rhythm check", "Only if bradycardia persists"]),
          ...
          {
            order: 14,
            questionText: "What is the recommended energy dose for the first defibrillation in pediatric VF/pVT?",
            options: JSON.stringify(["1 J/kg", "2 J/kg", "4 J/kg", "10 J/kg"]),
            correctAnswer: "2 J/kg",
          ...
          {
            order: 15,
            questionText: "If VF/pVT persists after the third shock, what is the recommended dose of Amiodarone?",
            options: JSON.stringify(["2.5 mg/kg IV/IO", "5 mg/kg IV/IO", "10 mg/kg IV/IO", "15 mg/kg IV/IO"]),
          ...
          {
            order: 16,
            questionText: "How many total doses of Amiodarone (initial + repeat) can be given for refractory VF/pVT according to 2025 guidelines?",
          ...
          {
            order: 17,
            questionText: "What is the initial medication for symptomatic bradycardia in a child with adequate perfusion?",
            options: JSON.stringify(["Atropine", "Epinephrine", "Adenosine", "Amiodarone"]),
          ...
          {
            order: 18,
            questionText: "For refractory supraventricular tachycardia (SVT) in a child, what is a newly recommended medication in the 2025 guidelines?",
            options: JSON.stringify(["Procainamide", "Sotalol IV", "Digoxin", "Verapamil"]),
          ...
          {
            order: 19,
            questionText: "What is the recommended temperature management strategy for a child post-cardiac arrest?",
            options: JSON.stringify(["Aggressive cooling to 32-34°C", "Targeted temperature management to prevent fever (>37.5°C)", "Passive rewarming to normothermia", "Maintain hyperthermia to improve neurological outcome"]),
          ...
          {
            order: 20,
            questionText: "Which of the following is a key component of post-cardiac arrest care aimed at improving neurological outcomes?",
            options: JSON.stringify(["Avoiding sedation", "Maintaining strict hyperglycemia", "Optimizing ventilation and oxygenation", "Early mobilization"]),
          ...
          {
            order: 21,
            questionText: "What is the primary responsibility of the PALS Team Leader during a resuscitation?",
            options: JSON.stringify(["Performing chest compressions", "Administering medications", "Assigning roles and making treatment decisions", "Documenting all events"]),
          ...
          {
            order: 22,
            questionText: "Which communication technique is essential for ensuring messages are understood and tasks are completed?",
            options: JSON.stringify(["Open-ended questions", "Closed-loop communication", "Briefing", "Debriefing"]),
            correctAnswer: "Closed-loop communication",
          ...
          {
            order: 23,
            questionText: "What is the primary role of the CPR Coach in a PALS resuscitation team?",
            options: JSON.stringify(["To manage the airway", "To administer medications", "To ensure high-quality chest compressions and coordinate switches", "To record events and times"]),
          ...
          {
            order: 24,
            questionText: "When should a debriefing ideally occur after a resuscitation event?",
            options: JSON.stringify(["Only if the patient had a poor outcome", "As soon as possible after the event", "During the next team meeting", "Only if requested by the team leader"]),
          ...
          {
            order: 25,
            questionText: "Which of the following best describes the Team Leader's involvement in hands-on tasks during a PALS resuscitation?",
            options: JSON.stringify(["Always performs chest compressions", "Actively participates in all tasks", "Should avoid hands-on tasks unless absolutely necessary", "Primarily focuses on medication administration"]),
...
},
{
  order: 10,
  title: "Module 10: PALS Summative Exam",
  description: "Comprehensive assessment of PALS 2025 knowledge, covering all modules. Score ≥80% required to pass.",
  content: "This module contains the summative examination for the PALS 2025 course. It assesses your understanding of all critical concepts and skills taught throughout the course.",
  duration: 60,
  sections: [
    {
      order: 1,
