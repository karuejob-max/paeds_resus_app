...
import { codeSignalEventsRouter } from "./routers/code-signal-events";
...
import { iersShiftTeamRouter } from "./routers/iers-shift-team";
...
export const appRouter = router({
  ...
  codeSignalEvents: codeSignalEventsRouter,
  ...
  iers: iersRouter,
  iersShiftTeam: iersShiftTeamRouter,
  ...
  institutionAccountability: institutionAccountabilityRouter,
