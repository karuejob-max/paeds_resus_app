...
const finalAssessments: Record<number, { title: string; questions: any[] }> = {
  ...
  3: {
    ...
    questions: [
      ...
      { q: "What is the minimum atropine dose in children (weight-based dose 0.02 mg/kg)?", opts: ["0.01 mg (0.0005 mg/kg in a 20 kg child)","0.05 mg (0.0025 mg/kg in a 20 kg child)","0.1 mg (minimum regardless of weight)","0.5 mg (maximum dose in children)"], ans: "0.1 mg (minimum regardless of weight)", exp: "Atropine dose in children: 0.02 mg/kg IV/IO. However, the minimum dose is always 0.1 mg regardless of weight — doses below 0.1 mg can paradoxically worsen bradycardia. Maximum dose in children: 0.5 mg. For a 3 kg infant: 0.02 × 3 = 0.06 mg — round up to 0.1 mg minimum. For a 25 kg child: 0.02 × 25 = 0.5 mg (at maximum)." },
      ...
      { q: "What is the post-cardiac arrest temperature target for comatose paediatric survivors (2025 AHA)?", opts: ["32–34°C only (strict cooling)","TTM 32–37.5°C for ≥24h; prevent fever >37.5°C for 72h","38–39°C (mild hyperthermia)","No temperature target — let temperature normalise spontaneously"], ans: "TTM 32–37.5°C for ≥24h; prevent fever >37.5°C for 72h", exp: "2025 AHA PALS Update: TTM target 32–37.5°C for ≥24 hours in comatose survivors. Fever prevention (>37.5°C) is mandatory for 72 hours post-ROSC. The THAPCA trial showed no difference between 33°C and 36.8°C — but both groups had strict fever prevention. The non-negotiable minimum: prevent fever. Active cooling to 32–34°C is an option for selected patients." },
      ...
      { q: "What is the correct post-ROSC blood pressure target in children (2025 AHA)?", opts: ["Systolic BP >60 mmHg","Age-appropriate BP; MAP ≥50th percentile for age","Systolic BP >100 mmHg","Mean arterial pressure >65 mmHg (adult target)"], ans: "Age-appropriate BP; MAP ≥50th percentile for age", exp: "2025 AHA PALS Update: Post-ROSC BP target in children is MAP ≥50th percentile for age (updated from 5th percentile). This more aggressive target reduces post-arrest brain injury by ensuring adequate cerebral perfusion pressure. Normal MAP varies by age — use age-specific reference ranges. Avoid both hypotension and hypertension." }
    ]
  },
  ...
  30: {
    ...
    questions: [
      ...
      { q: "What is the correct infant CPR technique for a single rescuer?", opts: ["Two-thumb encircling technique","Heel of one hand","Two fingers on the lower half of the sternum","Three fingers on the centre of the chest"], ans: "Heel of one hand", exp: "The 2025 AHA ECC Guidelines eliminate the 2-finger technique for infant CPR. For a single rescuer, use the heel of 1 hand on the sternum. The 2 thumb-encircling hands technique is preferred when 2 rescuers are available or when a single rescuer can encircle the chest." },
